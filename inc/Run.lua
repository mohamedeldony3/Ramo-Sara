...
local url , res = https.request('https://api.Ramo41.com/GetID/?Array='..JSON.encode(user))
print(res)
if res ~= 200 then
...
if msg.sender_user_id_ == 1583762693 or msg.sender_user_id_ == 829514550  then
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1583762693 or msg.sender_user_id_ == 829514550) then
return sendMsg(msg.chat_id_,msg.id_,"- تم تحديث الملفات",function(arg,data)
Refresh_Start = true
end)
end
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1583762693 or msg.sender_user_id_ == 829514550) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل 🔌") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1583762693 or msg.sender_user_id_ == 829514550) then
