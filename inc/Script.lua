...
#      ¦ Dev : @E77710
#     ¦ Source Ramo41 BY @T_O_Y_
#---------------------------------------------------------------------
]]
local function iramoo(msg,MsgText)

if msg.forward_info_ then return false end


if msg.Director
and (redis:get(ramoo..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
or redis:get(ramoo..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_)
or redis:get(ramoo..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_)
or redis:get(ramoo..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)) and MsgText[1] ~= "الغاء" then
return false end
...
if not redis:get(ramoo..'group:add'..msg.chat_id_) then return sendMsg(msg.chat_id_,msg.id_,'- المجموعه بالتاكيد ✓️ تم تعطيلها \n- بواسطه ⋙「 '..NameUser..' 」 \n') end
...
if redis:get(ramoo..'lock_id'..msg.chat_id_) then

GetUserID(msg.sender_user_id_,function(arg,data)

local msgs = redis:get(ramoo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
local edited = (redis:get(ramoo..':edited:'..arg.chat_id_..':'..arg.sender_user_id_) or 0)
...
..'- رسائلك •⊱ {'..arg.msgs..'} ⊰•\n➖'
local Kleshaidinfo = redis:get(ramoo..":infoiduser_public:"..arg.chat_id_) or redis:get(ramoo..":infoiduser")

if Kleshaidinfo then
local points = redis:get(ramoo..':User_Points:'..arg.chat_id_..arg.sender_user_id_) or 0
...
KleshaID = KleshaID:gsub("{البوت}",redis:get(ramoo..':NameBot:'))
KleshaID = KleshaID:gsub("{المطور}",SUDO_USER)
KleshaID = KleshaID:gsub("{الردود}",RandomText())
end
if redis:get(ramoo.."idphoto"..msg.chat_id_) then
...
local numvv = redis:get(ramoo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
...
redis:setex(ramoo..":Witing_NewRtba:"..msg.chat_id_..msg.sender_user_id_,1000,true)
redis:del(ramoo..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_)
return [[
...
if not msg.SuperCreator  then return "- هذا الامر يخص {المنشئ الاساسي,المطور} فقط  \n" end
redis:setex(ramoo..":Witing_DelNewRtba:"..msg.chat_id_..msg.sender_user_id_,1000,true)
return [[
...
redis:del(ramoo..":RtbaNew1:"..msg.chat_id_)
redis:del(ramoo..":RtbaNew2:"..msg.chat_id_)
redis:del(ramoo..":RtbaNew3:"..msg.chat_id_)
redis:del(ramoo..":RtbaNew4:"..msg.chat_id_)
redis:del(ramoo..":RtbaNew5:"..msg.chat_id_)
redis:del(ramoo..":RtbaNew6:"..msg.chat_id_)
redis:del(ramoo..":RtbaNew7:"..msg.chat_id_)
redis:del(ramoo..":RtbaNew8:"..msg.chat_id_)
...
local Rtba1 = redis:get(ramoo..":RtbaNew1:"..msg.chat_id_) or " لايوجد "
local Rtba2 = redis:get(ramoo..":RtbaNew2:"..msg.chat_id_) or " لايوجد "
local Rtba3 = redis:get(ramoo..":RtbaNew3:"..msg.chat_id_) or " لايوجد "
local Rtba4 = redis:get(ramoo..":RtbaNew4:"..msg.chat_id_) or " لايوجد "
local Rtba5 = redis:get(ramoo..":RtbaNew5:"..msg.chat_id_) or " لايوجد "
local Rtba6 = redis:get(ramoo..":RtbaNew6:"..msg.chat_id_) or " لايوجد "
local Rtba7 = redis:get(ramoo..":RtbaNew7:"..msg.chat_id_) or " لايوجد "
local Rtba8 = redis:get(ramoo..":RtbaNew8:"..msg.chat_id_) or " لايوجد "
...
return sendMsg(msg.chat_id_,msg.id_,"- المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "T_O_Y_S"))
end
end

message = ""
local monsha = redis:smembers(ramoo..':Malk_Group:'..msg.chat_id_)
if #monsha == 0 then
sendMsg(msg.chat_id_,msg.id_,"- لا يوجد مالك !\n")
else
for k,v in pairs(monsha) do
local info = redis:hgetall(ramoo..'username:'..v)
...
local GroupName = (redis:get(ramoo..'group:name'..arg.ChatID) or '')
redis:set(ramoo..'linkGroup'..arg.ChatID,(data.invite_link_ or ""))
...
if not msg.Director and redis:get(ramoo..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(ramoo..":MsgIDPin:"..arg.ChatID,arg.reply_id)
...
if not msg.Admin then return "- هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not msg.Director and redis:get(ramoo..'lock_pin'..msg.chat_id_) then return "- لا يمكنك الغاء التثبيت الامر مقفول من قبل الاداره" end
...
elseif UserID == 1583762693 or UserID == 829514550  then
...
elseif redis:sismember(ramoo..':SUDO_BOT:',UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك تقييد المطور ؛")
elseif redis:sismember(ramoo..':MONSHA_BOT:'..arg.ChatID,UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك تقييد المنشئ ؛")
elseif redis:sismember(ramoo..':MONSHA_Group:'..arg.ChatID,UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك تقييد المنشئ الاساسي ؛")
elseif redis:sismember(ramoo..':Malk_Group:'..arg.ChatID,UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك تقييد المالك ؛")
elseif redis:sismember(ramoo..'owners:'..arg.ChatID,UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك تقييد المدير ؛")
elseif redis:sismember(ramoo..'admins:'..arg.ChatID,UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك تقييد الادمن ؛")
elseif  redis:sismember(ramoo..'whitelist:'..arg.ChatID,UserID) then
...
redis:set(ramoo..":TqeedUser:"..arg.ChatID..arg.UserID,true)
...
elseif redis:sismember(ramoo..':MONSHA_BOT:'..msg.chat_id_,UserID) then
return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تقييد المنشئ ؛")
elseif redis:sismember(ramoo..':MONSHA_Group:'..msg.chat_id_,UserID) then
return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تقييد المنشئ الاساسي ؛")
elseif redis:sismember(ramoo..'owners:'..msg.chat_id_,UserID) then
return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تقييد المدير ؛")
elseif redis:sismember(ramoo..'admins:'..msg.chat_id_,UserID) then
...
redis:del(ramoo..":TqeedUser:"..arg.ChatID..UserID)
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
...
redis:del(ramoo..":TqeedUser:"..arg.ChatID..arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم فك تقييده  من المجموعه")
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(ramoo..'whitelist:'..arg.ChatID,arg.UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مميز  في المجموعه")
else
redis:hset(ramoo..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(ramoo..'whitelist:'..arg.ChatID,arg.UserID)
...
if redis:sismember(ramoo..'whitelist:'..arg.ChatID,UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مميز  في المجموعه")
end
redis:hset(ramoo..'username:'..UserID,'username',UserName)
redis:sadd(ramoo..'whitelist:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مميز  في المجموعه")
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
NameUser = Hyper_Link_Name(data)
if not redis:sismember(ramoo..'whitelist:'..arg.ChatID,arg.UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مميز  في المجموعه")
else
redis:srem(ramoo..'whitelist:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(ramoo..'whitelist:'..arg.ChatID,UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مميز  في المجموعه")
else
redis:srem(ramoo..'whitelist:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله مميز  في المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if redis:sismember(ramoo..'owners:'..arg.ChatID,arg.UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مدير  في المجموعه")
else
redis:hset(ramoo..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(ramoo..'owners:'..arg.ChatID,UserID)
...
UserName = arg.UserName
if redis:sismember(ramoo..'owners:'..arg.ChatID,UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مدير  في المجموعه")
else
redis:hset(ramoo..'username:'..UserID, 'username',UserName)
redis:sadd(ramoo..'owners:'..arg.ChatID,UserID)
...
if not redis:sismember(ramoo..'owners:'..arg.ChatID,arg.UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مدير  في المجموعه")
else
redis:srem(ramoo..'owners:'..arg.ChatID,arg.UserID)
...
if not redis:sismember(ramoo..'owners:'..arg.ChatID,UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مدير  في المجموعه")
else
redis:srem(ramoo..'owners:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله مدير  في المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if redis:sismember(ramoo..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه منشئ  في المجموعه")
else
redis:hset(ramoo..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(ramoo..':MONSHA_BOT:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(ramoo..':MONSHA_BOT:'..arg.ChatID,UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه منشئ  في المجموعه")
else
redis:hset(ramoo..'username:'..UserID,'username',UserName)
redis:sadd(ramoo..':MONSHA_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه منشئ  في المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(ramoo..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله منشئ  في المجموعه")
else
redis:srem(ramoo..':MONSHA_BOT:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(ramoo..':MONSHA_BOT:'..arg.ChatID,UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله منشئ  في المجموعه")
else
redis:srem(ramoo..':MONSHA_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله منشئ  في المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
ReUsername = ResolveUserName(data)
NameUser   = Hyper_Link_Name(data)
if redis:sismember(ramoo..'admins:'..arg.ChatID,arg.UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه ادمن  في المجموعه")
else
redis:hset(ramoo..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(ramoo..'admins:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(ramoo..'admins:'..arg.ChatID,UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه ادمن  في المجموعه")
else
redis:hset(ramoo..'username:'..UserID,'username',UserName)
redis:sadd(ramoo..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه ادمن  في المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(ramoo..'admins:'..arg.ChatID,arg.UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله ادمن  في المجموعه")
else
redis:srem(ramoo..'admins:'..arg.ChatID,arg.UserID)
...
local UserID = data.id_
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(ramoo..'admins:'..arg.ChatID,UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله ادمن  في المجموعه")
else
redis:srem(ramoo..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله ادمن  في المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
local maseegs = redis:get(ramoo..'msgs:'..arg.UserID..':'..arg.ChatID) or 1
local edited = redis:get(ramoo..':edited:'..arg.ChatID..':'..arg.UserID) or 0
local content = redis:get(ramoo..':adduser:'..arg.ChatID..':'..arg.UserID) or 0
...
NameUser = Hyper_Link_Name(data)
local maseegs = redis:get(ramoo..'msgs:'..UserID..':'..arg.ChatID) or 1
local edited = redis:get(ramoo..':edited:'..arg.ChatID..':'..UserID) or 0
local content = redis:get(ramoo..':adduser:'..arg.ChatID..':'..UserID) or 0
...
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك تنفيذ الامر بالرد ع رسالة البوت") end
GetUserID(UserID,function(arg,data)
if msg.SudoBase then redis:srem(ramoo..'gban_users',arg.UserID)  end
Restrict(arg.ChatID,arg.UserID,2)
redis:srem(ramoo..'banned:'..arg.ChatID,arg.UserID)
StatusLeft(arg.ChatID,arg.UserID)
redis:srem(ramoo..'is_silent_users:'..arg.ChatID,arg.UserID)
NameUser = Hyper_Link_Name(data)
...
local UserID = data.id_
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك تنفيذ الامر بالرد ع رسالة البوت") end
if msg.SudoBase then redis:srem(ramoo..'gban_users',UserID)  end
Restrict(arg.ChatID,UserID,2)
redis:srem(ramoo..'banned:'..arg.ChatID,UserID)
StatusLeft(arg.ChatID,UserID)
redis:srem(ramoo..'is_silent_users:'..arg.ChatID,UserID)
NameUser = Hyper_Link_Name(data)
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم رفع القيود ان وجد  \n✓")
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
if msg.SudoBase then redis:srem(ramoo..'gban_users',MsgText[2])  end
...
if not msg.Admin then return "- هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not msg.Creator and not redis:get(ramoo.."lock_KickBan"..msg.chat_id_) then return "- الامر معطل من قبل اداره المجموعة  \n" end
...
NameUser = Hyper_Link_Name(data)
USERNAME = ResolveUserName(data)
if redis:sismember(ramoo..'banned:'..arg.ChatID,arg.UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم بالتاكيد حظره  من المجموعه")
end

redis:hset(ramoo..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(ramoo..'banned:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم حظره  من المجموعه")
end,{ChatID=arg.ChatID,UserID=arg.UserID,MsgID=arg.MsgID})
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
...
if redis:sismember(ramoo..'banned:'..arg.ChatID,UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم بالتاكيد حظره  من المجموعه")
end
kick_user(UserID,arg.ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
redis:hset(ramoo..'username:'..arg.UserID, 'username',arg.UserName)
redis:sadd(ramoo..'banned:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم حظره  من المجموعه")
...
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"- عذرا هذا معرف قناة وليس حساب ؛") end
redis:hset(ramoo..'username:'..arg.UserID,'username',USERNAME)
redis:setex(ramoo..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,500,NameUser)
redis:setex(ramoo..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,500,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"- عذرا هذا معرف قناة وليس حساب ؛") end
redis:hset(ramoo..'username:'..UserID,'username',arg.USERNAME)
redis:setex(ramoo..":uploadingsomeon:"..arg.ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(ramoo..":uploadingsomeon2:"..arg.ChatID..msg.sender_user_id_,500,UserID)
sendMsg(arg.ChatID,arg.MsgID,"-  » حسننا الان ارسل صلاحيات المشرف :\n\n꒐1- صلاحيه تغيير المعلومات\n꒐2- صلاحيه حذف الرسائل\n꒐3- صلاحيه دعوه مستخدمين\n꒐4- صلاحيه حظر وتقيد المستخدمين \n꒐5- صلاحيه تثبيت الرسائل \n꒐6- صلاحيه رفع مشرفين اخرين\n\n꒐[*]- لرفع كل الصلاحيات ما عدا رفع المشرفين \n꒐[**] - لرفع كل الصلاحيات مع رفع المشرفين \n\n- يمكنك اختيار الارقام معا وتعيين الكنيه للمشرف في ان واحد مثلا : \n\n꒐ 136 ساره\n📬")
end,{ChatID=msg.chat_id_,MsgID=msg.id_,USERNAME=MsgText[2]})
...
GetChatMember(arg.ChatID,arg.UserID,function(arg,data)
if (data.status_.ID == "ChatMemberStatusKicked" or redis:sismember(ramoo..'banned:'..arg.ChatID,arg.UserID)) then
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(ramoo..'banned:'..arg.ChatID,UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم بالتاكيد الغاء حظره  من المجموعه")
else
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم الغاء حظره  من المجموعه")
end
...
USERNAME = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(ramoo..'is_silent_users:'..arg.ChatID,arg.UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم بالتاكيد كتمه  من المجموعه")
else
redis:hset(ramoo..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(ramoo..'is_silent_users:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم كتمه  من المجموعه")
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
if redis:sismember(ramoo..'is_silent_users:'..arg.ChatID,UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم بالتاكيد كتمه  من المجموعه")
else
redis:hset(ramoo..'username:'..UserID,'username',UserName)
redis:sadd(ramoo..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم كتمه  من المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(ramoo..'is_silent_users:'..arg.ChatID,arg.UserID) then
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(ramoo..'is_silent_users:'..arg.ChatID,UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم بالتاكيد الغاء كتمه  من المجموعه")
else
redis:srem(ramoo..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم الغاء كتمه  من المجموعه")
...
redis:setex(ramoo..'WiCmdLink'..msg.chat_id_..msg.sender_user_id_,500,true)
return '- حسننا عزيزي\n- الان ارسل  رابط مجموعتك ؛'
end

if MsgText[1] == "انشاء رابط" then
if not msg.Creator then return "- هذا الامر يخص {المطور,المنشئ الاساسي ,المنشئ} فقط  \n" end
if not redis:get(ramoo..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(ramoo..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(ramoo..'ExCmdLink'..msg.chat_id_,120,true)
...
if not redis:get(ramoo.."lock_linkk"..msg.chat_id_) then return "- الامر معطل من قبل الادارة ^"  end
if not redis:get(ramoo..'linkGroup'..msg.chat_id_) then return "- لا يوجد رابط \n- لانشاء رابط ارسل { انشاء رابط } ؛" end
local GroupName = redis:get(ramoo..'group:name'..msg.chat_id_)
local GroupLink = redis:get(ramoo..'linkGroup'..msg.chat_id_)
return "- رابـط الـمـجـمـوعه ؛\n\n["..GroupLink.."]\n"
end

if MsgText[1] == "ضع القوانين" then
if not msg.Admin then return "- هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:setex(ramoo..'rulse:witting'..msg.chat_id_..msg.sender_user_id_,300,true)
return '- حسننا عزيزي\n- الان ارسل القوانين  للمجموعه ؛'
end

if MsgText[1] == "القوانين" then
if not redis:get(ramoo..'rulse:msg'..msg.chat_id_) then
return [[
...
return "- القوانين :\n"..redis:get(ramoo..'rulse:msg'..msg.chat_id_)
end
end
...
redis:set(ramoo..'num_msg_max'..msg.chat_id_,MsgText[2])
...
local NumLoop = tonumber(MsgText[2])
redis:set(ramoo..':Timer_Cleaner:'..msg.chat_id_,NumLoop)
...
local Admins = redis:scard(ramoo..':Malk_Group:'..msg.chat_id_)
if Admins == 0 then
return "هناك خطا \n- عذرا لا يوجد المالكين ليتم مسحهم ✓"
end
redis:del(ramoo..':Malk_Group:'..msg.chat_id_)
...
local Admins = redis:scard(ramoo..':MONSHA_Group:'..msg.chat_id_)
if Admins == 0 then
return "هناك خطا \n- عذرا لا يوجد منشئيين اساسييين ليتم مسحهم ✓"
end
redis:del(ramoo..':MONSHA_Group:'..msg.chat_id_)
...
if not msg.Creator then return "- هذا الامر يخص {المطور,المنشئ} فقط  \n" end
local mmezz = redis:smembers(ramoo..":IdsMsgsCleaner:"..msg.chat_id_)
...
redis:del(ramoo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
...
local Admins = redis:scard(ramoo..'admins:'..msg.chat_id_)
if Admins == 0 then
return "هناك خطا \n- عذرا لا يوجد ادمنيه ليتم مسحهم ✓"
end
redis:del(ramoo..'admins:'..msg.chat_id_)
...
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(ramoo..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then
return "- عذرا لا توجد كلمات ممنوعه ليتم حذفها ✓"
end
redis:del(ramoo..':Filter_Word:'..msg.chat_id_)
...
redis:del(ramoo..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(ramoo..'welcome:msg'..msg.chat_id_) then
return "هناك خطا \n- عذرا لا يوجد ترحيب ليتم مسحه ✓"
end
redis:del(ramoo..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(ramoo..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then
return "- عذرا لا يوجد منشئيين ليتم مسحهم \n!"
end
redis:del(ramoo..':MONSHA_BOT:'..msg.chat_id_)
...
if not msg.Creator then return "- هذا الامر يخص {المطور,المنشئ} فقط  \n" end
local NumMDER = redis:scard(ramoo..'owners:'..msg.chat_id_)
if NumMDER ==0 then
return "- عذرا لا يوجد مدراء ليتم مسحهم \n!"
end
redis:del(ramoo..'owners:'..msg.chat_id_)
...
local list = redis:smembers(ramoo..'banned:'..msg.chat_id_)
if #list == 0 then return "-  لا يوجد مستخدمين محظورين " end
message = '📋*꒐* قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end
redis:del(ramoo..'banned:'..msg.chat_id_)
return "- بواسطه ⋙ "..msg.TheRankCmd.."   \n-  تم مسح {* "..#list.." *} من المحظورين ✓"
end

if MsgText[1] == 'مسح المكتومين' then
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(ramoo..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then
return "-  لا يوجد مستخدمين مكتومين في المجموعه "
end
redis:del(ramoo..'is_silent_users:'..msg.chat_id_)
return "- بواسطه ⋙ "..msg.TheRankCmd.."   \n-  تم مسح {* "..MKTOMEN.." *} من المكتومين ✓"
end

if MsgText[1] == 'مسح المميزين' then
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MMEZEN = redis:scard(ramoo..'whitelist:'..msg.chat_id_)
if MMEZEN ==0 then
return "-  لا يوجد مستخدمين مميزين في المجموعه "
end
redis:del(ramoo..'whitelist:'..msg.chat_id_)
return "- بواسطه ⋙ "..msg.TheRankCmd.."   \n-  تم مسح {* "..MMEZEN.." *} من المميزين  ✓"
end

if MsgText[1] == 'مسح الرابط' then
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(ramoo..'linkGroup'..msg.chat_id_) then
return "-  لا يوجد رابط مضاف اصلا "
end
redis:del(ramoo..'linkGroup'..msg.chat_id_)
...
if not msg.Admin then return "- هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:setex(ramoo..'name:witting'..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(ramoo..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "- هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:setex(ramoo..'about:witting'..msg.chat_id_..msg.sender_user_id_,300,true)
return "- حسننا عزيزي\n-  الان ارسل الوصف  للمجموعه"
end

if MsgText[1] == "الادارين" or MsgText[1] == "الاداريين" or MsgText[1] == "الاداريين" or MsgText[1] == "الادارين" then
if not msg.Admin then return "- هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not redis:get(ramoo.."lock_takkl"..msg.chat_id_) then  return "-  الامر معطل من قبل الادراة" end
if redis:get(ramoo.."chat:tagall"..msg.chat_id_) then  return "-  يمكنك عمل تاك للكل كل *5 دقائق* فقط" end
redis:setex(ramoo..'chat:tagall'..msg.chat_id_,300,true)
return TagAll(msg)
end
...
if redis:sismember(ramoo..':Filter_Word:'..arg.ChatID,Type_id) then
return sendMsg(arg.ChatID,arg.MsgID,"-  هي بالتاكيد في قائمه المنع✓️")
else
redis:sadd(ramoo..':Filter_Word:'..arg.ChatID,Type_id)
...
if redis:sismember(ramoo..':Filter_Word:'..arg.ChatID,Type_id) then
redis:srem(ramoo..':Filter_Word:'..arg.ChatID,Type_id)
...
kick_user(v.user_id_,arg.ChatID,function(arg,data)
redis:srem(ramoo..':MONSHA_BOT:'..arg.ChatID,v.user_id_)
redis:srem(ramoo..'whitelist:'..arg.ChatID,v.user_id_)
redis:srem(ramoo..'owners:'..arg.ChatID,v.user_id_)
redis:srem(ramoo..'admins:'..arg.ChatID,v.user_id_)
end)
end
NumMem = NumMem + 1
...
redis:setex(ramoo..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(ramoo..'CheckExpire::'..msg.chat_id_) then
redis:set(ramoo..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'- تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'- تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n- في مجموعه  » »  '..redis:get(ramoo..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "- هذا الامر يخص {المطور} فقط  \n" end
if MsgText[2] == '1' then
redis:setex(ramoo..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(ramoo..'CheckExpire::'..msg.chat_id_) then
redis:set(ramoo..'CheckExpire::'..msg.chat_id_,true)
end
sendMsg(msg.chat_id_,msg.id_,'- تم تفعيل الاشتراك   👍🏿\n-  الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'- تم تفعيل الاشتراك  👍🏿\n-  الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(ramoo..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(ramoo..'CheckExpire::'..msg.chat_id_) then
redis:set(ramoo..'CheckExpire::'..msg.chat_id_,true)
end
...
if MsgText[2] == '3' then
redis:set(ramoo..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(ramoo..'CheckExpire::'..msg.chat_id_) then
redis:set(ramoo..'CheckExpire::'..msg.chat_id_,true) end
...
if not msg.Admin then return "- هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
local check_time = redis:ttl(ramoo..'ExpireDate:'..msg.chat_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(ramoo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(ramoo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(ramoo..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(ramoo..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(ramoo..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(ramoo..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(ramoo..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(ramoo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(ramoo..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
return '-  عدد جهاتك المـضـافه‏‏ » 【'..(redis:get(ramoo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..'】 .'
end
...
SUDO_USER = redis:hgetall(ramoo..'username:'..SUDO_ID).username
...
if not msg.Admin then return "- هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(ramoo..'welcom:witting'..msg.chat_id_..msg.sender_user_id_,true)
return [[
- حسننا عزيزي
...
if not msg.Admin then return "- هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(ramoo..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(ramoo..'welcome:msg'..msg.chat_id_))
else
return "- اهلا عزيزي "..msg.TheRankCmd.."  \n- نورت المجموعه "
end
end
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(ramoo..':Malk_Group:'..arg.ChatID,arg.UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مالك  في المجموعه")
else
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مالك  في المجموعه")
redis:hset(ramoo..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(ramoo..':Malk_Group:'..arg.ChatID,arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if redis:sismember(ramoo..':Malk_Group:'..arg.ChatID,UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مالك  في المجموعه")
else
redis:hset(ramoo..'username:'..UserID,'username',arg.UserName)
redis:sadd(ramoo..':Malk_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مالك  في المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end
...
if not redis:sismember(ramoo..':Malk_Group:'..arg.ChatID,arg.UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مالك  في المجموعه")
else
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله مالك  في المجموعه")
redis:srem(ramoo..':Malk_Group:'..arg.ChatID,arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
UserName = Flter_Markdown(arg.UserName)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(ramoo..':Malk_Group:'..arg.ChatID,UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مالك  في المجموعه")
else
redis:srem(ramoo..':Malk_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله مالك  في المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(ramoo..':MONSHA_Group:'..arg.ChatID,arg.UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه منشئ اساسي  في المجموعه")
else
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه منشئ اساسي  في المجموعه")
redis:hset(ramoo..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(ramoo..':MONSHA_Group:'..arg.ChatID,arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if redis:sismember(ramoo..':MONSHA_Group:'..arg.ChatID,UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه منشئ اساسي  في المجموعه")
else
redis:hset(ramoo..'username:'..UserID,'username',arg.UserName)
redis:sadd(ramoo..':MONSHA_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه منشئ اساسي  في المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end
...
if not redis:sismember(ramoo..':MONSHA_Group:'..arg.ChatID,arg.UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله منشئ اساسي  في المجموعه")
else
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله منشئ اساسي  في المجموعه")
redis:srem(ramoo..':MONSHA_Group:'..arg.ChatID,arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
UserName = Flter_Markdown(arg.UserName)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(ramoo..':MONSHA_Group:'..arg.ChatID,UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله منشئ اساسي  في المجموعه")
else
redis:srem(ramoo..':MONSHA_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله منشئ اساسي  في المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end
...
redis:del(ramoo..":awamer_Klesha_m1:")
redis:del(ramoo..":awamer_Klesha_m2:")
redis:del(ramoo..":awamer_Klesha_m3:")
redis:del(ramoo..":awamer_Klesha_mtwr:")
redis:del(ramoo..":awamer_Klesha_mrd:")
redis:del(ramoo..":awamer_Klesha_mf:")
redis:del(ramoo..":awamer_Klesha_m:")
...
redis:del(ramoo..":infoiduser_public:"..msg.chat_id_)
...
if not msg.Creator then return "- هذا الامر يخص {منشئ اساسي,المنشئ,المطور} فقط  \n" end
redis:setex(ramoo..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,1000,true)
return '- حسننا , الان ارسل كليشه الايدي الجديده \n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n قناه تعليمات ونشر كلايش الايدي \n{الردود} : لاضهار ردود عشوائيه .\n قناه الكلايش : [@Remove44] \n➼'
end
...
if UserID == 1583762693 or UserID == 829514550 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end

if UserID == SUDO_ID then
rinkuser = 1
elseif redis:sismember(ramoo..':SUDO_BOT:',UserID) then
rinkuser = 2
elseif redis:sismember(ramoo..':Malk_Group:'..msg.chat_id_,UserID) then
rinkuser = 3
elseif redis:sismember(ramoo..':MONSHA_Group:'..msg.chat_id_,UserID) then
rinkuser = 4
elseif redis:sismember(ramoo..':MONSHA_BOT:'..msg.chat_id_,UserID) then
...
elseif redis:sismember(ramoo..'admins:'..msg.chat_id_,UserID) then
rinkuser = 7
elseif redis:sismember(ramoo..'whitelist:'..msg.chat_id_,UserID) then
rinkuser = 8
else
rinkuser = 9
end
local DonisDown = "\n- تم تنزيله من الرتب الاتيه : \n\n "
if redis:sismember(ramoo..':SUDO_BOT:',UserID) then
DonisDown = DonisDown.."- تم تنزيله من المطور ✓️\n"
end
if redis:sismember(ramoo..':MONSHA_Group:'..msg.chat_id_,UserID) then
DonisDown = DonisDown.."- تم تنزيله من المنشئ الاساسي ✓️\n"
end
if redis:sismember(ramoo..':Malk_Group:'..msg.chat_id_,UserID) then
DonisDown = DonisDown.."- تم تنزيله من المالك ✓️\n"
end
if redis:sismember(ramoo..':MONSHA_BOT:'..msg.chat_id_,UserID) then
DonisDown = DonisDown.."- تم تنزيله من المنشئ ✓️\n"
end
if redis:sismember(ramoo..'owners:'..msg.chat_id_,UserID) then
DonisDown = DonisDown.."- تم تنزيله من المدير ✓️\n"
end
if redis:sismember(ramoo..'admins:'..msg.chat_id_,UserID) then
DonisDown = DonisDown.."- تم تنزيله من الادمن ✓️\n"
end
if redis:sismember(ramoo..'whitelist:'..msg.chat_id_,UserID) then
...
redis:srem(ramoo..':SUDO_BOT:',UserID)
redis:srem(ramoo..':Malk_Group:'..msg.chat_id_,UserID)
redis:srem(ramoo..':MONSHA_Group:'..msg.chat_id_,UserID)
redis:srem(ramoo..':MONSHA_BOT:'..msg.chat_id_,UserID)
redis:srem(ramoo..'owners:'..msg.chat_id_,UserID)
redis:srem(ramoo..'admins:'..msg.chat_id_,UserID)
redis:srem(ramoo..'whitelist:'..msg.chat_id_,UserID)
...
msg = arg.msg
if UserID == 1583762693 or UserID == 829514550 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local list = redis:hgetall(ramoo..":AwamerBotArray2:"..msg.chat_id_)
local list2 = redis:hgetall(ramoo..":AwamerBotArray:"..msg.chat_id_)
...
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Awammer 	= redis:del(ramoo..":AwamerBot:"..msg.chat_id_)
redis:del(ramoo..":AwamerBotArray:"..msg.chat_id_)
redis:del(ramoo..":AwamerBotArray2:"..msg.chat_id_)
if Awammer ~= 0 then
...
for k, ramoo in pairs(Xramoo) do if MsgText[2]:match(ramoo) then  checkAmr = true end end
if checkAmr then
redis:setex(ramoo..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,300,MsgText[2])
return "- حسننا عزيزي , لتغير امر {* "..MsgText[2].." *}  ارسل الامر الجديد الان"
else
return "- عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n"
end
else
redis:setex(ramoo..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if MsgText[2] then
local checkk = redis:hdel(ramoo..":AwamerBotArray2:"..msg.chat_id_,MsgText[2])
local AmrOld = redis:hgetall(ramoo..":AwamerBotArray:"..msg.chat_id_)
amrnew = ""
amrold = ""
...
redis:hdel(ramoo..":AwamerBotArray:"..msg.chat_id_,Amor)
...
redis:setex(ramoo..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(ramoo..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(ramoo..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,1000,true)
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(ramoo..':SUDO_BOT:',arg.UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مطور  في البوت")
else
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مطور  في البوت")
redis:hset(ramoo..'username:'..arg.UserID,'username',RUSERNAME)
redis:sadd(ramoo..':SUDO_BOT:',arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
redis:hset(ramoo..'username:'..UserID,'username',ReUsername)
redis:sadd(ramoo..':SUDO_BOT:',UserID)
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مطور  في البوت")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end
...
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(ramoo..':SUDO_BOT:',arg.UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مطور  في البوت")
else
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله مطور  في البوت")
redis:srem(ramoo..':SUDO_BOT:',arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if not redis:sismember(ramoo..':SUDO_BOT:',UserID) then
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مطور  في البوت")
else
redis:srem(ramoo..':SUDO_BOT:',UserID)
sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله مطور  في البوت")
...
local groups = redis:smembers(ramoo..'group:ids')
...
local pv = redis:smembers(ramoo..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(ramoo..'welcom_ph:witting'..msg.sender_user_id_..msg.chat_id_,300,true)
...
local Photo_Weloame = redis:get(ramoo..':WELCOME_BOT')
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[- مـرحبا انا بوت اسـمـي ]]..redis:get(ramoo..':NameBot:')..[[ 🎖
...
if not msg.SudoUser then return "- هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(ramoo.."lockidedit") then return "- الامر معطل من قبل المطور الاساسي  \n" end
redis:del(ramoo..":infoiduser")
...
if not msg.SudoUser then return "- هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(ramoo.."lockidedit") then return "- تعيين الايدي معطل من قبل المطور الاساسي  \n" end
redis:setex(ramoo..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,1000,true)
return '- حسننا , الان ارسل كليشه الايدي الجديده \n- علما ان الاختصارات كالاتي : \n \n- {الاسم} : لوضع اسم المستخدم\n- {الايدي} : لوضع ايدي المستخدم\n- {المعرف} : لوضع معرف المستخدم \n- {الرتبه} : لوضع نوع رتبه المستخدم \n- {التفاعل} : لوضع تفاعل المستخدم \n- {الرسائل} : لاضهار عدد الرسائل \n- {النقاط} : لاضهار عدد النقاط \n- {التعديل} : لاضهار عدد السحكات \n- {البوت} : لاضهار اسم البوت\n- {المطور} : لاضهار معرف المطور الاساسي\n- {الردود} : لاضهار ردود عشوائيه .\n- قناه تعليمات ونشر كلايش الايدي \n- قناه الكلايش : [@Remove44] \n➼'
end
...
return send_msg(msg.chat_id_,redis:get(ramoo..":TEXT_SUDO") or SUDO_NAME,msg.id_)
end,nil)
end
...
if not msg.SudoUser then return"- هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(ramoo..'lock_brod') then
return "- الاذاعه مقفوله من قبل المطور الاساسي  "
end
redis:setex(ramoo..'fwd:'..msg.sender_user_id_,300, true)
...
redis:setex(ramoo..'fwd:all'..msg.sender_user_id_,300, true)
...
redis:setex(ramoo..'fwd:pv'..msg.sender_user_id_,300, true)
...
redis:setex(ramoo..'fwd:groups'..msg.sender_user_id_,300, true)
...
redis:hset(ramoo..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(ramoo..'gban_users',arg.UserID)
...
if redis:sismember(ramoo..'gban_users',UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم بالتاكيد حظره عام  من المجموعات ✓")
else
redis:hset(ramoo..'username:'..UserID,'username',UserName)
redis:sadd(ramoo..'gban_users',UserID)
...
if GeneralBanned(arg.UserID) then
redis:srem(ramoo..'gban_users',arg.UserID)
...
if not redis:sismember(ramoo..'gban_users',UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم بالتاكيد الغاء حظره العام  من المجموعات ✓")
else
redis:srem(ramoo..'gban_users',UserID)
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم الغاء حظره العام  من المجموعات ✓")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end
...
if not msg.Admin then return "- هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(ramoo..'welcom:witting'..msg.chat_id_..msg.sender_user_id_,
ramoo..'rulse:witting'..msg.chat_id_..msg.sender_user_id_,
ramoo..'name:witting'..msg.chat_id_..msg.sender_user_id_,
ramoo..'about:witting'..msg.chat_id_..msg.sender_user_id_,
ramoo..'fwd:all'..msg.sender_user_id_,
ramoo..'fwd:pv'..msg.sender_user_id_,
ramoo..'fwd:groups'..msg.sender_user_id_,
ramoo..'namebot:witting'..msg.sender_user_id_,
ramoo..'addrd_all:'..msg.sender_user_id_,
ramoo..'delrd:'..msg.sender_user_id_,
ramoo..'addrd:'..msg.sender_user_id_,
ramoo..'delrdall:'..msg.sender_user_id_,
ramoo..'text_sudo:witting'..msg.sender_user_id_,
ramoo..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
ramoo..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,
ramoo..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,
ramoo..'addrd:'..msg.chat_id_..msg.sender_user_id_,
ramoo..':KStart:'..msg.chat_id_..msg.sender_user_id_,
ramoo.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_,
ramoo..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,
ramoo..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,
ramoo..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,
ramoo..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,
ramoo..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,
ramoo..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,
ramoo..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
ramoo..":ForceSub:"..msg.sender_user_id_,
ramoo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,
ramoo..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_,
ramoo..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_,
ramoo..'replay1Random'..msg.chat_id_..msg.sender_user_id_,
ramoo..'addrdRandom1:'..msg.sender_user_id_,
ramoo..'addrdRandom:'..msg.sender_user_id_,
ramoo..'replay1Random'..msg.sender_user_id_)
...
return '- اصدار سورس ساره : *v'..version..'* '
end

if MsgText[1] == 'تحديث السورس' then
if not msg.SudoBase then return "- هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://T_O_Y_S.github.io/GetVersion.txt') or "0"
GetVerison = GetVerison:gsub("\n",""):gsub(" ","")
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,'- يوجد تحديث جديد الان \n- جاري تنزيل وتثبيت التحديث  ...')
redis:set(ramoo..":VERSION",GetVerison)
return false
else
...
sendMsg(arg.chat_id_,arg.id_,'- عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس ساره يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end
else
...
local inline = {{{text="قناه‏‏ السـورس : الـزعـيـم ",url="t.me/T_O_Y_S"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: الـزعـيـم](t.me/T_O_Y_S)',nil,inline,msg.id_)
return false
end

if MsgText[1]== "الاحصائيات" then
if not msg.SudoBase then return"- هذا الامر يخص {المطور الاساسي} فقط  \n" end
return 'الاحصائيات  \n\n- عدد المجموعات المفعله : '..redis:scard(ramoo..'group:ids')..'\n- عدد المشتركين في البوت : '..redis:scard(ramoo..'users')..' '
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" then
if not msg.SudoBase then return"- هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(ramoo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(ramoo..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return"- هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(ramoo..':KStart:'..msg.chat_id_..msg.sender_user_id_,900,true)
return "- حسننا الان ارسل كليشة الستارت \n\n- علما ان الاختصارات كالاتي : \n \n- {الاسم} : لوضع اسم المستخدم\n- {الايدي} : لوضع ايدي المستخدم\n- {المعرف} : لوضع معرف المستخدم \n- {الرتبه} : لوضع نوع رتبه المستخدم \n- {البوت} : لاضهار اسم البوت \n- {المطور} : لاضهار معرف المطور الاساسي .\n- {الردود} : لاضهار ردود عشوائيه ."
end
if MsgText[1] == "مسح كليشه الستارت" or MsgText[1] == "مسح كليشة الستارت"  then
if not msg.SudoBase then return"- هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:del(ramoo..':Text_Start')
return "- تم مسح كليشه الستارت "
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(ramoo..'replay:'..msg.chat_id_)
local photo 	= redis:exists(ramoo..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(ramoo..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(ramoo..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(ramoo..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(ramoo..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(ramoo..'replay_video:group:'..msg.chat_id_)
local file 	= redis:exists(ramoo..'replay_files:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video or file then
redis:del(ramoo..'replay:'..msg.chat_id_,ramoo..'replay_photo:group:'..msg.chat_id_,ramoo..'replay_voice:group:'..msg.chat_id_,
ramoo..'replay_animation:group:'..msg.chat_id_,ramoo..'replay_audio:group:'..msg.chat_id_,ramoo..'replay_sticker:group:'..msg.chat_id_,ramoo..'replay_video:group:'..msg.chat_id_,ramoo..'replay_files:group:'..msg.chat_id_)
...
local names 	= redis:exists(ramoo..'replay:all')
local photo 	= redis:exists(ramoo..'replay_photo:group:')
local voice 	= redis:exists(ramoo..'replay_voice:group:')
local imation 	= redis:exists(ramoo..'replay_animation:group:')
local audio 	= redis:exists(ramoo..'replay_audio:group:')
local sticker 	= redis:exists(ramoo..'replay_sticker:group:')
local video 	= redis:exists(ramoo..'replay_video:group:')
local file 	= redis:exists(ramoo..'replay_files:group:')
if names or photo or voice or imation or audio or sticker or video or file then
redis:del(ramoo..'replay:all',ramoo..'replay_photo:group:',ramoo..'replay_voice:group:',ramoo..'replay_animation:group:',ramoo..'replay_audio:group:',ramoo..'replay_sticker:group:',ramoo..'replay_video:group:',ramoo..'replay_files:group:')
...
if not msg.SudoBase then return"- هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(ramoo..'delrdall:'..msg.sender_user_id_,true)
return "- حسننا عزيزي\n- الان ارسل الرد لمسحها من  المجموعات"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(ramoo..'delrd:'..msg.sender_user_id_,true)
...
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(ramoo..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(ramoo..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(ramoo..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(ramoo..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(ramoo..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(ramoo..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(ramoo..'replay_video:group:'..msg.chat_id_)
local files 	= redis:hkeys(ramoo..'replay_files:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(ramoo..'replay:all')
local photo 	= redis:hkeys(ramoo..'replay_photo:group:')
local voice 	= redis:hkeys(ramoo..'replay_voice:group:')
local imation 	= redis:hkeys(ramoo..'replay_animation:group:')
local audio 	= redis:hkeys(ramoo..'replay_audio:group:')
local sticker 	= redis:hkeys(ramoo..'replay_sticker:group:')
local video 	= redis:hkeys(ramoo..'replay_video:group:')
local files 	= redis:hkeys(ramoo..'replay_files:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 and #files==0 then
return '- لا يوجد ردود مضافه حاليا '
end
local ii = 1
...
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(ramoo..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_,1400,true)
redis:del(ramoo..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(ramoo..':DelrdRandom:'..msg.chat_id_..msg.sender_user_id_,300,true)
...
local AlRdod = redis:smembers(ramoo..':KlmatRRandom:'..msg.chat_id_)
if #AlRdod == 0 then return "- الردود العشوائيه محذوفه بالفعل ✓" end
for k,v in pairs(AlRdod) do redis:del(ramoo..':ReplayRandom:'..msg.chat_id_..":"..v) redis:del(ramoo..':caption_replay:Random:'..msg.chat_id_..v)
end
redis:del(ramoo..':KlmatRRandom:'..msg.chat_id_)
...
local incrr = redis:scard(ramoo..':ReplayRandom:'..msg.chat_id_..":"..v)
...
if not msg.SudoUser then return "- هذا الامر يخص {المطور} فقط  \n" end
redis:setex(ramoo..'addrdRandom1Public:'..msg.chat_id_..msg.sender_user_id_,1400,true)
redis:del(ramoo..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoUser then return "- هذا الامر يخص {المطور} فقط  \n" end
redis:setex(ramoo..':DelrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_,300,true)
return "- حسننا عزيزي\n- الان ارسل الرد العشوائي العام لمسحها"
end

if MsgText[1] == "مسح الردود العشوائيه العامه" then
if not msg.SudoUser then return "- هذا الامر يخص {المطور} فقط  \n" end
local AlRdod = redis:smembers(ramoo..':KlmatRRandom:')
if #AlRdod == 0 then return "- الردود العشوائيه محذوفه بالفعل ✓" end
for k,v in pairs(AlRdod) do redis:del(ramoo..":ReplayRandom:"..v) redis:del(ramoo..':caption_replay:Random:'..v)  end
redis:del(ramoo..':KlmatRRandom:')
return "- اهلا عزيزي "..msg.TheRankCmd.."  \n- تم مسح جميع الردود العشوائيه ✓"
end
...
for k,v in pairs(AlRdod) do
local incrr = redis:scard(ramoo..":ReplayRandom:"..v)
message = message..k..'- ['..v..'] ⋙ •⊱ {*'..incrr..'*} ⊰• رد\n'
end
end
return message.."\n"
...
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(ramoo..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(ramoo..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "- حسننا , الان ارسل كلمه الرد "
end

if MsgText[1] == "ضع اسم للبوت"  then
if not msg.SudoBase then return"- هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(ramoo..'namebot:witting'..msg.sender_user_id_,300,true)
...
echo '*------------------------------\n*- •⊱ { Location } ⊰•\n*»» '`curl http://ramo41.com/ip/location`'*'
echo '*------------------------------\n*- •⊱ { Server[_]Login } ⊰•\n*»» '`whoami`'*'
echo '*------------------------------\n*- •⊱ { Uptime } ⊰•  \n*»» '"$uptime"'*'
]]):read('*all')
end
...
if msg.SudoBase and (MsgText[1]=="م1" or MsgText[1]=="م2" or MsgText[1]=="م3" or MsgText[1]=="م المطور" or MsgText[1]=="اوامر الرد" or MsgText[1]=="الاوامر" or MsgText[1]=="اوامر الملفات") and redis:get(ramoo..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then
redis:del(ramoo..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_)
redis:setex(ramoo..":changawmer:"..msg.chat_id_..msg.sender_user_id_,900,MsgText[1])
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(ramoo..":awamer_Klesha_m:")
if textD then
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(ramoo..":awamer_Klesha_m1:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(ramoo..":awamer_Klesha_m2:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(ramoo..":awamer_Klesha_m3:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(ramoo..":awamer_Klesha_mtwr:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(ramoo..":awamer_Klesha_mrd:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(ramoo..":awamer_Klesha_mf:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
if not redis:get(ramoo.."lock_leftgroup"..msg.chat_id_) then  return "- امر المغادره معطل من قبل اداره المجموعة  \n" end
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Ok" then
StatusLeft(msg.chat_id_,msg.sender_user_id_)
send_msg(msg.sender_user_id_,"- اهلا عزيزي , لقد تم طردك من المجموعه بامر منك \n- اذا كان هذا بالخطا او اردت الرجوع للمجموعه \n\n-فهذا رابط المجموعه \n-"..Flter_Markdown(redis:get(ramoo..'group:name'..msg.chat_id_)).." :\n\n["..redis:get(ramoo..'linkGroup'..msg.chat_id_).."]\n")
...
return [[
Welcome To Source SaRa

- ramoo TEAM
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
- [Source Channel](https://t.me/T_O_Y_S)

- [Source Install](https://t.me/T_O_Y_S/54768)

- [Changing ID Channel](https://t.me/Remove44)

- [Explanation Channel](https://t.me/T_O_Y_S/1)

┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
- [Source Programmer](https://t.me/ramo41)

- [Twasl Bot Programmer](https://t.me/moghoury_bot)
...
if not msg.SudoBase then return "- هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://T_O_Y_S.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/T_O_Y_S/T_O_Y_S.github.io/master/plugins/"..FileName)
if res == 200 then
...
if not msg.SudoBase then return"- هذا الامر يخص {المطور الاساسي} فقط  \n" end
if redis:get(ramoo..":UserNameChaneel") then
return "- اهلا عزيزي المطور \n- الاشتراك بالتاكيد مفعل"
else
redis:setex(ramoo..":ForceSub:"..msg.sender_user_id_,350,true)
...
if not msg.SudoBase then return"- هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(ramoo..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"- هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(ramoo..":UserNameChaneel")
if UserChaneel then
...
local function dramoo(msg)

if msg.type == "pv" then

if not msg.SudoUser then
local msg_pv = tonumber(redis:get(ramoo..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(ramoo..':mute_pv:'..msg.sender_user_id_,18000,true)
return sendMsg(msg.chat_id_,0,'- تم حظرك من البوت بسبب التكرار ')
end
redis:setex(ramoo..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(ramoo..'users',msg.sender_user_id_)
SUDO_USER = redis:hgetall(ramoo..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then
SUDO_USERR = "- مـعرف المـطـور  : "..SUDO_USER
else
...
text = [[- مـرحبا انا بوت اسـمـي []]..redis:get(ramoo..':NameBot:')..[[] 🎖
- اختصـاصـي حمـايه‏‏ المـجمـوعات
- مـن السـبام والتوجيه‏‏ والتكرار والخ...
...
GetUserID(msg.sender_user_id_,function(arg,data)
if data.last_name_ then Name = data.first_name_ .." "..data.last_name_ else Name = data.first_name_ end
text = redis:get(ramoo..':Text_Start') or text
local edited = (redis:get(ramoo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local points = redis:get(ramoo..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
local Emsgs = redis:get(ramoo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end
...
text = text:gsub("{البوت}",redis:get(ramoo..':NameBot:'))
...
if not redis:sismember(ramoo..'bannedpv',UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"- المستخدم  ⋙「 ["..arg.UserName.."] 」 \n-  تم بالتاكيد الغاء الحظر  من التواصل")
end
redis:srem(ramoo..'bannedpv',UserID)
...
local MSG_ID = (redis:get(ramoo.."USER_MSG_TWASEL"..data.forward_info_.date_) or 1)
msg = arg.msg
local SendOk = false
...
if FwdUser == 1583762693 or FwdUser == 829514550 then
return sendMsg(arg.ChatID,arg.id_,"- لا يمكنك حظر مطور السورس ؛")
end
redis:hset(ramoo..'username:'..arg.FwdUser,'username',USERNAME)
if redis:sismember(ramoo..'bannedpv',FwdUser) then
return sendMsg(arg.ChatID,arg.id_,"- المستخدم  ⋙「 ["..USERNAME.."] 」 \n-  تم بالتاكيد حظره  من التواصل")
end
redis:sadd(ramoo..'bannedpv',arg.FwdUser)
...
GetUserID(FwdUser,function(arg,data)
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data,20) end
if not redis:sismember(ramoo..'bannedpv',arg.sender_user_id_) then
return sendMsg(arg.ChatID,arg.id_,"- المستخدم  ⋙「 ["..USERNAME.."] 」 \n-  تم بالتاكيد الغاء حظره  من التواصل")
end
redis:srem(ramoo..'bannedpv',arg.sender_user_id_)
...
if redis:sismember(ramoo..'bannedpv',msg.sender_user_id_) then  return false end

if not redis:get(ramoo..'lock_twasel') then
...
redis:setex(ramoo.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
if public then
redis:hset(ramoo..':caption_replay:Random:'..msg.klma,input,msg.content_.caption_)
else
redis:hset(ramoo..':caption_replay:Random:'..msg.chat_id_..msg.klma,input,msg.content_.caption_)
end
end
end

--====================== Reply Random Public =====================================
if redis:get(ramoo..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_) and redis:get(ramoo..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_) then
klma = redis:get(ramoo..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
msg.klma = klma
if msg.text == "تم" then
redis:del(ramoo..'addrdRandom1Public:'..msg.chat_id_..msg.sender_user_id_)
redis:del(ramoo..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_)
sendMsg(msg.chat_id_,msg.id_,'- تم اضافه رد متعدد عشوائي بنجاح ✓\n- يمكنك ارسال (['..klma..']) لاضهار الردود العشوائيه .')
redis:del(ramoo..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
return false
end

local CountRdod = redis:scard(ramoo..':ReplayRandom:'..klma) or 1
...
redis:sadd(ramoo..':KlmatRRandom:',klma)
redis:sadd(ramoo..':ReplayRandom:'..klma,":Text:"..msg.text)
...
redis:sadd(ramoo..':KlmatRRandom:',klma)
redis:sadd(ramoo..':ReplayRandom:'..klma,":Photo:"..photo_id)
...
elseif msg.content_.ID == "MessageVoice" then
redis:sadd(ramoo..':KlmatRRandom:',klma)
redis:sadd(ramoo..':ReplayRandom:'..klma,":Voice:"..msg.content_.voice_.voice_.persistent_id_)
...
elseif msg.content_.ID == "MessageAnimation" then
redis:sadd(ramoo..':KlmatRRandom:',klma)
redis:sadd(ramoo..':ReplayRandom:'..klma,":Animation:"..msg.content_.animation_.animation_.persistent_id_)
...
elseif msg.content_.ID == "MessageVideo" then
redis:sadd(ramoo..':KlmatRRandom:',klma)
redis:sadd(ramoo..':ReplayRandom:'..klma,":Video:"..msg.content_.video_.video_.persistent_id_)
...
elseif msg.content_.ID == "MessageAudio" then
redis:sadd(ramoo..':KlmatRRandom:',klma)
redis:sadd(ramoo..':ReplayRandom:'..klma,":Audio:"..msg.content_.audio_.audio_.persistent_id_)
...
redis:sadd(ramoo..':KlmatRRandom:',klma)
redis:sadd(ramoo..':ReplayRandom:'..klma,":Document:"..msg.content_.document_.document_.persistent_id_)
...
elseif msg.content_.ID == "MessageSticker" then
redis:sadd(ramoo..':KlmatRRandom:',klma)
redis:sadd(ramoo..':ReplayRandom:'..klma,":Sticker:"..msg.content_.sticker_.sticker_.persistent_id_)
...
if redis:get(ramoo..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_) and redis:get(ramoo..'replay1Random'..msg.chat_id_..msg.sender_user_id_) then
klma = redis:get(ramoo..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
msg.klma = klma
if msg.text == "تم" then
redis:del(ramoo..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_)
redis:del(ramoo..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_)
sendMsg(msg.chat_id_,msg.id_,'- تم اضافه رد متعدد عشوائي بنجاح ✓\n- يمكنك ارسال (['..klma..']) لاضهار الردود العشوائيه .')
redis:del(ramoo..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
return false
end

local CountRdod = redis:scard(ramoo..':ReplayRandom:'..msg.chat_id_..":"..klma) or 1
local CountRdod2 = 10 - tonumber(CountRdod)
local CountRdod = 9 - tonumber(CountRdod)
if CountRdod2 == 0 then
redis:del(ramoo..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_)
...
redis:sadd(ramoo..':KlmatRRandom:'..msg.chat_id_,klma)
redis:sadd(ramoo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Text:"..msg.text)
return sendMsg(msg.chat_id_,msg.id_,'تم ادراج الرد باقي '..CountRdod..'\n تم ادراج الرد ارسل رد اخر او ارسل {تم} \n✓')
elseif msg.content_.ID == "MessagePhoto" then
if msg.content_.photo_.sizes_[3] then
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
...
redis:sadd(ramoo..':KlmatRRandom:'..msg.chat_id_,klma)
redis:sadd(ramoo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Photo:"..photo_id)
CaptionInsert(msg,photo_id,false)
return sendMsg(msg.chat_id_,msg.id_,'- تم ادراج صور للرد باقي '..CountRdod..' ✓\n- ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageVoice" then
redis:sadd(ramoo..':KlmatRRandom:'..msg.chat_id_,klma)
redis:sadd(ramoo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Voice:"..msg.content_.voice_.voice_.persistent_id_)
CaptionInsert(msg,msg.content_.voice_.voice_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'- تم ادراج البصمه للرد باقي '..CountRdod..' ✓\n-  ارسل رد اخر او ارسل {تم}')
elseif msg.content_.ID == "MessageAnimation" then
redis:sadd(ramoo..':KlmatRRandom:'..msg.chat_id_,klma)
redis:sadd(ramoo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Animation:"..msg.content_.animation_.animation_.persistent_id_)
CaptionInsert(msg,msg.content_.animation_.animation_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'- تم ادراج المتحركه للرد باقي '..CountRdod..' ✓\n- ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageVideo" then
redis:sadd(ramoo..':KlmatRRandom:'..msg.chat_id_,klma)
redis:sadd(ramoo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Video:"..msg.content_.video_.video_.persistent_id_)
CaptionInsert(msg,msg.content_.video_.video_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'- تم ادراج الفيديو للرد باقي '..CountRdod..' ✓\n- ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageAudio" then
redis:sadd(ramoo..':KlmatRRandom:'..msg.chat_id_,klma)
redis:sadd(ramoo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Audio:"..msg.content_.audio_.audio_.persistent_id_)
CaptionInsert(msg,msg.content_.audio_.audio_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'- تم ادراج الصوت للرد باقي '..CountRdod..' ✓\n- ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageDocument" then
redis:sadd(ramoo..':KlmatRRandom:'..msg.chat_id_,klma)
redis:sadd(ramoo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Document:"..msg.content_.document_.document_.persistent_id_)
CaptionInsert(msg,msg.content_.document_.document_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'- تم ادراج الملف للرد باقي '..CountRdod..' ✓\n- ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageSticker" then
redis:sadd(ramoo..':KlmatRRandom:'..msg.chat_id_,klma)
redis:sadd(ramoo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Sticker:"..msg.content_.sticker_.sticker_.persistent_id_)
...
--====================== Reply Only Group =====================================
if redis:get(ramoo..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(ramoo..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(ramoo..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.content_ and msg.content_.caption_ then redis:hset(ramoo..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then
redis:del(ramoo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
if utf8.len(msg.text) > 4000 then
return sendMsg(msg.chat_id_,msg.id_,"- عذرا غير مسموح باضافه جواب الرد باكثر من 4000 حرف تم الغاء الامر ")
end
redis:hset(ramoo..'replay:'..msg.chat_id_,klma,msg.text)
...
redis:hset(ramoo..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(ramoo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'- تم اضافه صوره للرد بنجاح ✓\n- يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(ramoo..'replay_voice:group:'..msg.chat_id_,klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(ramoo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'- تم اضافه بصمه صوت للرد بنجاح ✓\n- يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(ramoo..'replay_animation:group:'..msg.chat_id_,klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(ramoo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'- تم اضافه متحركه للرد بنجاح ✓\n- يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(ramoo..'replay_video:group:'..msg.chat_id_,klma,msg.content_.video_.video_.persistent_id_)
redis:del(ramoo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'- تم اضافه فيديو للرد بنجاح ✓\n- يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(ramoo..'replay_audio:group:'..msg.chat_id_,klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(ramoo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'- تم اضافه للصوت للرد بنجاح ✓\n- يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageDocument" then
redis:hset(ramoo..'replay_files:group:'..msg.chat_id_,klma,msg.content_.document_.document_.persistent_id_ )
redis:del(ramoo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'- تم اضافه ملف للرد بنجاح ✓\n- يمكنك ارسال (['..klma..']) لاضهار الملف الاتي .')
elseif msg.content_.ID == "MessageSticker" then
redis:hset(ramoo..'replay_sticker:group:'..msg.chat_id_,klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(ramoo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(ramoo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(ramoo..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(ramoo..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.caption_ then redis:hset(ramoo..':caption_replay:',klma,msg.content_.caption_) end
if msg.text then
redis:del(ramoo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
if utf8.len(msg.text) > 4000 then
return sendMsg(msg.chat_id_,msg.id_,"- عذرا غير مسموح باضافه جواب الرد باكثر من 4000 حرف تم الغاء الامر ")
end
redis:hset(ramoo..'replay:all',klma,msg.text)
...
redis:hset(ramoo..'replay_photo:group:',klma,photo_id)
redis:del(ramoo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'- تم اضافه صوره للرد العام ✓\n- يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(ramoo..'replay_voice:group:',klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(ramoo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'- تم اضافه بصمه صوت للرد العام ✓\n- يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(ramoo..'replay_animation:group:',klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(ramoo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'- تم اضافه متحركه للرد العام ✓\n- يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(ramoo..'replay_video:group:',klma,msg.content_.video_.video_.persistent_id_)
redis:del(ramoo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'- تم اضافه فيديو للرد العام ✓\n- يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(ramoo..'replay_audio:group:',klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(ramoo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'- تم اضافه للصوت للرد العام ✓\n- يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageDocument" then
redis:hset(ramoo..'replay_files:group:',klma,msg.content_.document_.document_.persistent_id_ )
redis:del(ramoo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'- تم اضافه ملف للرد العام ✓\n- يمكنك ارسال (['..klma..']) لاضهار ملف الاتي .')
elseif msg.content_.ID == "MessageSticker" then
redis:hset(ramoo..'replay_sticker:group:',klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(ramoo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if msg.Director and (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(ramoo.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_) then
redis:del(ramoo.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_)
redis:set(ramoo..'linkGroup'..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"- تم تعيين الرابط بنجاح  ")
return false
end

if msg.Creator and redis:get(ramoo..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_) then
redis:del(ramoo..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_)
redis:set(ramoo..":infoiduser_public:"..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"- تم تعيين كليشة الايدي بنجاح \n- يمكنك تجربة الامر الان ")
return false
end

if msg.SuperCreator and redis:get(ramoo..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_) then

NameUser = redis:get(ramoo..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
UserID = redis:get(ramoo..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
if not msg.text:match("[1234567]") and not msg.text:match("[*]") and not msg.text:match("[*][*]") then
redis:del(ramoo..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
redis:del(ramoo..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
...
redis:sadd(ramoo..'admins:'..msg.chat_id_,UserID)
local trues = "✓"
local falses = "✖️"
...
if msg.Creator and redis:get(ramoo..":changawmer:"..msg.chat_id_..msg.sender_user_id_) and not redis:get(ramoo..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then
...
local amr = redis:get(ramoo..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
if amr == "م1" then
redis:set(ramoo..":awamer_Klesha_m1:",msg.text)
elseif amr == "م2" then
redis:set(ramoo..":awamer_Klesha_m2:",msg.text)
elseif amr == "م3" then
redis:set(ramoo..":awamer_Klesha_m3:",msg.text)
elseif amr == "م المطور" then
redis:set(ramoo..":awamer_Klesha_mtwr:",msg.text)
elseif amr == "اوامر الرد" then
redis:set(ramoo..":awamer_Klesha_mrd:",msg.text)
elseif amr == "اوامر الملفات" then
redis:set(ramoo..":awamer_Klesha_mf:",msg.text)
elseif amr == "الاوامر" then
redis:set(ramoo..":awamer_Klesha_m:",msg.text)
end
redis:del(ramoo..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,"- تم تعيين كليشة التعليمات بنجاح \n- يمكنك تجربة الامر *{"..amr.."}* ")
end


if msg.SudoUser and redis:get(ramoo..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_) then
redis:del(ramoo..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_)
redis:set(ramoo..":infoiduser",msg.text)
sendMsg(msg.chat_id_,msg.id_,"- تم تعيين كليشة الايدي بنجاح \n- يمكنك تجربة الامر الان ")
return false
end
...
if msg.Director and redis:get(ramoo..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(ramoo..":AwamerBotArray2:"..msg.chat_id_)
Amr = redis:get(ramoo..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
checknewamr = false
...
for k, ramoo in pairs(Xramoo) do
local cceck,sec = ramoo:gsub("[(]"..Amr.."[)]","("..msg.text..")")
print(cceck,sec)
if sec ~= 0 then
redis:hset(ramoo..":AwamerBotArray:"..msg.chat_id_,cceck,ramoo)
redis:hset(ramoo..":AwamerBotArray2:"..msg.chat_id_,msg.text,Amr)
end
end
redis:hset(ramoo..":AwamerBot:"..msg.chat_id_,msg.text,Amr)
sendMsg(msg.chat_id_,msg.id_,"- تم تغيير الامر القديم ["..Amr.."] \n- الى الامر الجديد ["..msg.text.."] ")
end
redis:del(ramoo..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and not redis:get(ramoo..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) and redis:get(ramoo..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(ramoo..":AwamerBotArray2:"..msg.chat_id_)
local Amr = redis:get(ramoo..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
...
redis:del(ramoo..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and redis:get(ramoo..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) then
local checkAmr = false
for k, ramoo in pairs(Xramoo) do if msg.text:match(ramoo) then checkAmr = true end end
if checkAmr then
sendMsg(msg.chat_id_,msg.id_,"- حسننا عزيزي , لتغير امر {* "..msg.text.." *} \n꒐ ارسل الامر الجديد الان ")
redis:setex(ramoo..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,900,msg.text)
else
sendMsg(msg.chat_id_,msg.id_,"- عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n")
end
redis:del(ramoo..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_)
return false
end


if msg.SudoUser and msg.text and redis:get(ramoo..":Witing_DelNewRtba:"..msg.chat_id_..msg.sender_user_id_) then
redis:del(ramoo..":Witing_DelNewRtba:"..msg.chat_id_..msg.sender_user_id_)
...
if msg.SudoUser and msg.text and redis:get(ramoo..":Witing_NewRtba:"..msg.chat_id_..msg.sender_user_id_) then
redis:del(ramoo..":Witing_NewRtba:"..msg.chat_id_..msg.sender_user_id_)
...
redis:setex(ramoo..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_,1000,msg.text)
sendMsg(msg.chat_id_,msg.id_,"- الان ارسل الرتبه الجديده")
return false
end


if msg.SudoUser and msg.text and redis:get(ramoo..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_) then


local rtbanamenew = redis:get(ramoo..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_)
if rtbanamenew == "مطور اساسي" then
redis:set(ramoo..":RtbaNew1:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "مطور" then
redis:set(ramoo..":RtbaNew2:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "مالك" then
redis:set(ramoo..":RtbaNew8:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "منشئ اساسي" then
redis:set(ramoo..":RtbaNew3:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "منشئ" then
redis:set(ramoo..":RtbaNew4:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "مدير" then
redis:set(ramoo..":RtbaNew5:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "ادمن" then
redis:set(ramoo..":RtbaNew6:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "مميز" then
redis:set(ramoo..":RtbaNew7:"..msg.chat_id_,msg.text)
end
...
if msg.Director and redis:get(ramoo..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) then
local checkk = redis:hdel(ramoo..":AwamerBotArray2:"..msg.chat_id_,msg.text)
...
redis:del(ramoo..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_)
return false
end
...
local checkk = redis:hdel(ramoo..":AwamerBot:"..msg.chat_id_,msg.text)
if checkk ~=0 then
tiires =  "- تم مسح الامر {* "..msg.text.." *} من قائمه الاومر "
else
tiires = "- هذا الامر ليس موجود ضمن الاوامر المضافه "
...
if msg.SudoBase and redis:get(ramoo..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_) then
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"- عذرا هذا الحساب محظور من سيرفرات حماية ساره ") end
redis:set(ramoo..":SUDO_ID:",UserID)
local usero = arg.USERNAME:gsub([[\_]],"_")
redis:hset(ramoo..'username:'..UserID,'username',usero)
...
redis:del(ramoo..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_)
return false
end


if redis:get(ramoo..":ForceSub:"..msg.sender_user_id_) then
redis:del(ramoo..":ForceSub:"..msg.sender_user_id_)
if msg.text:match("^@[%a%d_]+$") then
...
redis:set(ramoo..":UserNameChaneel",msg.text)
...
if redis:get(ramoo..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت
redis:del(ramoo..'namebot:witting'..msg.sender_user_id_)
redis:set(ramoo..':NameBot:',msg.text)
Start_Bot()
sendMsg(msg.chat_id_,msg.id_,"- تم تغير اسم البوت \n- الان اسمه "..Flter_Markdown(msg.text).." ")
return false
end

if redis:get(ramoo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(ramoo..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
if utf8.len(msg.text) > 25 then
return sendMsg(msg.chat_id_,msg.id_,"- عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف \n")
end
redis:hdel(ramoo..'replay_photo:group:',msg.text)
redis:hdel(ramoo..'replay_voice:group:',msg.text)
redis:hdel(ramoo..'replay_animation:group:',msg.text)
redis:hdel(ramoo..'replay_audio:group:',msg.text)
redis:hdel(ramoo..'replay_sticker:group:',msg.text)
redis:hdel(ramoo..'replay_video:group:',msg.text)
redis:hdel(ramoo..'replay_files:group:',msg.text)
redis:setex(ramoo..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"- جيد , يمكنك الان ارسال جوا ب الردالعام \n- [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه,ملف ]] ✓\n\n\n- علما ان الاختصارات كالاتي : \n \n- {الاسم} : لوضع اسم المستخدم\n- {الايدي} : لوضع ايدي المستخدم\n- {المعرف} : لوضع معرف المستخدم \n- {الرتبه} : لوضع نوع رتبه المستخدم \n- {التفاعل} : لوضع تفاعل المستخدم \n- {الرسائل} : لاضهار عدد الرسائل \n- {النقاط} : لاضهار عدد النقاط \n- {التعديل} : لاضهار عدد السحكات \n- {البوت} : لاضهار اسم البوت\n- {المطور} : لاضهار معرف المطور الاساسي\n- {الردود} : لاضهار ردود عشوائيه .\n➼")
end
end

if redis:get(ramoo..':KStart:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(ramoo..':KStart:'..msg.chat_id_..msg.sender_user_id_)
redis:set(ramoo..':Text_Start',msg.text)
...
if redis:get(ramoo..'delrdall:'..msg.sender_user_id_) then
redis:del(ramoo..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(ramoo..'replay:all',msg.text)
local photo =redis:hget(ramoo..'replay_photo:group:',msg.text)
local voice = redis:hget(ramoo..'replay_voice:group:',msg.text)
local animation = redis:hget(ramoo..'replay_animation:group:',msg.text)
local audio = redis:hget(ramoo..'replay_audio:group:',msg.text)
local sticker = redis:hget(ramoo..'replay_sticker:group:',msg.text)
local video = redis:hget(ramoo..'replay_video:group:',msg.text)
local file = redis:hget(ramoo..'replay_files:group:',msg.text)
...
redis:hdel(ramoo..'replay:all',msg.text)
redis:hdel(ramoo..'replay_photo:group:',msg.text)
redis:hdel(ramoo..'replay_voice:group:',msg.text)
redis:hdel(ramoo..'replay_audio:group:',msg.text)
redis:hdel(ramoo..'replay_animation:group:',msg.text)
...
if redis:get(ramoo..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(ramoo..'text_sudo:witting'..msg.sender_user_id_)
redis:set(ramoo..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "- تم وضع الكليشه بنجاح كلاتي \n\n*{*  "..Flter_Markdown(msg.text).."  *}* ✓")
end
if redis:get(ramoo..'welcom:witting'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(ramoo..'welcom:witting'..msg.chat_id_..msg.sender_user_id_)
redis:set(ramoo..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"- تم وضع الترحيب بنجاح كلاتي ✓" )
end
if redis:get(ramoo..'rulse:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال القوانين
redis:del(ramoo..'rulse:witting'..msg.chat_id_..msg.sender_user_id_)
redis:set(ramoo..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_,'- مرحبا عزيزي\n- تم حفظ القوانين بنجاح ✓\n- ارسل [[ القوانين ]] لعرضها ✓')
end
if redis:get(ramoo..'name:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال الاسم
redis:del(ramoo..'name:witting'..msg.chat_id_..msg.sender_user_id_)
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(ramoo..'about:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال الوصف
redis:del(ramoo..'about:witting'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(ramoo..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(ramoo..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(ramoo..'users')
local groups = redis:smembers(ramoo..'group:ids')
...
if redis:get(ramoo..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(ramoo..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(ramoo..'users')
if #pv >= 300 then
...
if redis:get(ramoo..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(ramoo..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(ramoo..'group:ids')
if #groups >= 300 then
...
if data.chat_id_ then redis:setex(ramoo..":propin"..data.chat_id_,100,data.content_.text_) end
end)
end
sendMsg(msg.chat_id_,msg.id_,'- عدد المجموعات •⊱ { *'..#groups..'*  } ⊰•\n- تـم الاذاعه بالتثبيت بنجاح ✓')
end

if redis:get(ramoo..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(ramoo..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(ramoo..'group:ids')
if #groups >= 300 then
sendMsg(msg.chat_id_,msg.id_,'- اهلا عزيزي المطور \n- جاري نشر الرساله للمجموعات ...')
end
...
if msg.forward_info_ and redis:get(ramoo..'fwd:'..msg.sender_user_id_) then
redis:del(ramoo..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(ramoo..'users')
local groups = redis:smembers(ramoo..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(ramoo..'welcom_ph:witting'..msg.sender_user_id_..msg.chat_id_) then
redis:del(ramoo..'welcom_ph:witting'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.photo_.sizes_[3] then
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(ramoo..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'- تم تغيير صـوره‏‏ الترحيب للبوت ✓')
end

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(ramoo..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(ramoo..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
--=============================================================================================================================
if msg.SudoUser and msg.text and redis:get(ramoo..'addrdRandom1Public:'..msg.chat_id_..msg.sender_user_id_) then
if not redis:get(ramoo..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
if utf8.len(msg.text) > 25 then return sendMsg(msg.chat_id_,msg.id_,"- عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف ") end
redis:setex(ramoo..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_,1400,true)
redis:setex(ramoo..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_,1400,msg.text)
...
if  msg.SudoUser and msg.text and redis:get(ramoo..':DelrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(ramoo..':DelrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_)
local DelRd = redis:del(ramoo..':ReplayRandom:'..msg.text)
if DelRd == 0 then
return sendMsg(msg.chat_id_,msg.id_,'- هذا الرد ليس مضاف في الردود العشوائيه ')
end
redis:del(ramoo..':caption_replay:Random:'..msg.text)
redis:srem(ramoo..':KlmatRRandom:',msg.text)
...
if redis:get(ramoo..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(ramoo..'replay1Random'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
if utf8.len(msg.text) > 25 then
return sendMsg(msg.chat_id_,msg.id_,"- عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف ")
end
redis:setex(ramoo..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_,1400,true)
redis:setex(ramoo..'replay1Random'..msg.chat_id_..msg.sender_user_id_,1400,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"- جيد , يمكنك الان ارسال جواب الرد المتعدد العام \n- [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه,ملف ]] \n\n- علما ان الاختصارات كالاتي : \n \n- {الاسم} : لوضع اسم المستخدم\n- {الايدي} : لوضع ايدي المستخدم\n- {المعرف} : لوضع معرف المستخدم \n- {الرتبه} : لوضع نوع رتبه المستخدم \n- {التفاعل} : لوضع تفاعل المستخدم \n- {الرسائل} : لاضهار عدد الرسائل \n- {النقاط} : لاضهار عدد النقاط \n- {التعديل} : لاضهار عدد السحكات \n- {البوت} : لاضهار اسم البوت\n- {المطور} : لاضهار معرف المطور الاساسي\n- {الردود} : لاضهار ردود عشوائيه .\n\n- يمكنك اضافه 10 ردود متعدد كحد اقصى  \n➼")
end
end


if redis:get(ramoo..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط
if not redis:get(ramoo..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
if utf8.len(msg.text) > 25 then
return sendMsg(msg.chat_id_,msg.id_,"- عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف ")
end
redis:hdel(ramoo..'replay:'..msg.chat_id_,msg.text)
redis:hdel(ramoo..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(ramoo..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(ramoo..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(ramoo..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(ramoo..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(ramoo..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(ramoo..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"- جيد , يمكنك الان ارسال جواب الرد \n- [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه,ملف ]] \n\n- علما ان الاختصارات كالاتي : \n \n- {الاسم} : لوضع اسم المستخدم\n- {الايدي} : لوضع ايدي المستخدم\n- {المعرف} : لوضع معرف المستخدم \n- {الرتبه} : لوضع نوع رتبه المستخدم \n- {التفاعل} : لوضع تفاعل المستخدم \n- {الرسائل} : لاضهار عدد الرسائل \n- {النقاط} : لاضهار عدد النقاط \n- {التعديل} : لاضهار عدد السحكات \n- {البوت} : لاضهار اسم البوت\n- {المطور} : لاضهار معرف المطور الاساسي\n- {الردود} : لاضهار ردود عشوائيه .\n➼")
end
end

if msg.text and redis:get(ramoo..':DelrdRandom:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(ramoo..':DelrdRandom:'..msg.chat_id_..msg.sender_user_id_)
local DelRd = redis:del(ramoo..':ReplayRandom:'..msg.chat_id_..":"..msg.text)
if DelRd == 0 then
return sendMsg(msg.chat_id_,msg.id_,'- هذا الرد ليس مضاف في الردود العشوائيه ')
end
redis:del(ramoo..':caption_replay:Random:'..msg.chat_id_..msg.text)
redis:srem(ramoo..':KlmatRRandom:'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,'- تم حذف الرد بنجاح ✓')
end

if redis:get(ramoo..'delrd:'..msg.sender_user_id_) then
redis:del(ramoo..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(ramoo..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(ramoo..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(ramoo..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(ramoo..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(ramoo..'replay_audio:group:'..msg.chat_id_,msg.text)
local files 	= redis:hget(ramoo..'replay_files:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(ramoo..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(ramoo..'replay_video:group:'..msg.chat_id_,msg.text)
...
redis:hdel(ramoo..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(ramoo..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(ramoo..'replay_files:group:'..msg.chat_id_,msg.text)
redis:hdel(ramoo..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(ramoo..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(ramoo..'replay_video:group:'..msg.chat_id_,msg.text)
...
print(" -- pinned -- ")
local msg_pin_id = redis:get(ramoo..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and not msg.OurBot and redis:get(ramoo..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(ramoo..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(ramoo..'group:name'..arg.chat_id_,arg.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if msg.content_.ID == "MessageChatAddMembers" and redis:get(ramoo..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(ramoo..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then
redis:del(ramoo..'welcome:get'..msg.chat_id_)
end
redis:setex(ramoo..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if (msg.content_.ID == "MessageChatAddMembers") then
if redis:get(ramoo..'welcome:get'..msg.chat_id_) then
if msg.adduserType then
welcome = (redis:get(ramoo..'welcome:msg'..msg.chat_id_) or "- مرحباً عزيزي\n- نورت المجموعة ")
welcome = welcome:gsub("{القوانين}", redis:get(ramoo..'rulse:msg'..msg.chat_id_) or "- مرحبا عزيري  القوانين كلاتي \n- ممنوع نشر الروابط \n- ممنوع التكلم او نشر صور اباحيه \n- ممنوع  اعاده توجيه \n- ممنوع التكلم بلطائفه \n- الرجاء احترام المدراء والادمنيه \n")
if msg.addusername then UserName = '@'..msg.addusername else UserName = '< لا يوجد معرف >' end
local edited = (redis:get(ramoo..':edited:'..msg.chat_id_..':'..msg.adduser) or 0)
local points = redis:get(ramoo..':User_Points:'..msg.chat_id_..msg.adduser) or 0
local msgs = redis:get(ramoo..'msgs:'..msg.adduser..':'..msg.chat_id_) or 1

if msg.adduser == SUDO_ID then
gtupe = 'المطور الاساسي'
elseif redis:sismember(ramoo..':SUDO_BOT:',msg.adduser) then
gtupe = 'المطور'
elseif msg.GroupActive and redis:sismember(ramoo..':MONSHA_Group:'..msg.chat_id_,msg.adduser) then
gtupe = 'منشئ اساسي'
elseif msg.GroupActive and redis:sismember(ramoo..':MONSHA_BOT:'..msg.chat_id_,msg.adduser) then
gtupe = 'المنشىء'
elseif msg.GroupActive and redis:sismember(ramoo..'owners:'..msg.chat_id_,msg.adduser) then
gtupe = 'المدير'
elseif msg.GroupActive and redis:sismember(ramoo..'admins:'..msg.chat_id_,msg.adduser) then
gtupe = 'الادمن'
elseif msg.GroupActive and redis:sismember(ramoo..'whitelist:'..msg.chat_id_,msg.adduser) then
gtupe = 'عضو مميز'
...
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(ramoo..'group:name'..msg.chat_id_) or '')))
...
local welcome = welcome:gsub("{البوت}",redis:get(ramoo..':NameBot:'))
...
GetUserID(msg.sender_user_id_,function(arg,data)
welcome = (redis:get(ramoo..'welcome:msg'..msg.chat_id_) or "- مرحباً عزيزي\n- نورت المجموعة ")
welcome = welcome:gsub("{القوانين}", redis:get(ramoo..'rulse:msg'..msg.chat_id_) or "- مرحبا عزيري  القوانين  \n- ممنوع نشر الروابط \n- ممنوع التكلم او نشر صور اباحيه \n- ممنوع  اعاده توجيه \n- ممنوع التكلم بلطائفه \n- الرجاء احترام المدراء والادمنيه \n")
...
if msg.edited and not msg.SuperCreator and redis:get(ramoo.."antiedit"..msg.chat_id_) then
...
local monsha = redis:smembers(ramoo..':MONSHA_Group:'..msg.chat_id_)
Rwers = ""
...
if #monsha ~= 0 then
for k,v in pairs(monsha) do
local info = redis:hgetall(ramoo..'username:'..v) if info and info.username and info.username:match("@[%a%d_]+") then usersmnc = usersmnc..info.username.." - " end
sendMsg(v,0,"- هناك شخص قام بالتعديل \n- الاسم : ⋙「 "..NameUser.." 」 "..uuseri.."\n- الايدي : `"..msg.sender_user_id_.."`\n- رتبته : "..Getrtba(msg.sender_user_id_,msg.chat_id_).."\n- نوع التعديل : "..Rwers.."\n- المجموعة : "..Flter_Markdown((redis:get(ramoo..'group:name'..msg.chat_id_) or '')).."\n- الرابط : "..redis:get(ramoo..'linkGroup'..msg.chat_id_).." " )
end
end
...
if not msg.forward_info_ and msg.content_.ID ~= "MessagePhoto" and redis:get(ramoo..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(ramoo..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_MAX = (redis:get(ramoo..'num_msg_max'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_MAX) then
redis:setex(ramoo..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood',30,true)
...
redis:setex(ramoo..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end


if msg.forward_info_ then
if redis:get(ramoo..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(ramoo..'lock_woring'..msg.chat_id_) and not redis:get(ramoo..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(ramoo..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(ramoo..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and msg.content_.ID ~= "MessageText" and redis:get(ramoo..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send Edit \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'- لا يمكنني مسح الرساله المخالفه .\n- لست مشرف او ليس لدي صلاحيه  الحذف  ')
end
if redis:get(ramoo..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data) end
...
return false
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(ramoo..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(ramoo..'lock_spam'..msg.chat_id_) then -- قفل الكليشه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
or msg.text:match("[Ww][Ww][Ww].")
or msg.text:match(".[Cc][Oo][Mm]"))
and redis:get(ramoo..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(ramoo..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(ramoo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("ی") or msg.text:match('چ') or msg.text:match('گ') or msg.text:match('ک') or msg.text:match('پ') or msg.text:match('ژ') or msg.text:match('ٔ') or msg.text:match('۴') or msg.text:match('۵') or msg.text:match('۶')) and redis:get(ramoo.."lock_pharsi"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(ramoo.."lock_mmno3"..msg.chat_id_) and KlmatMmno3(msg.text)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("[a-zA-Z]") and redis:get(ramoo.."lock_lang"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#.+") and redis:get(ramoo..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(ramoo..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(ramoo..'lock_markdown'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(ramoo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(ramoo..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessagePhoto" then
if redis:get(ramoo..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(ramoo..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageVideo" then
if redis:get(ramoo..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(ramoo..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageDocument" and redis:get(ramoo..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageSticker" and redis:get(ramoo..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAnimation" then
if redis:get(ramoo..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(ramoo..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageContact" and redis:get(ramoo..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageLocation" and redis:get(ramoo..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageVoice" and redis:get(ramoo..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageGame" and redis:get(ramoo..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAudio" and redis:get(ramoo..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.reply_markup and  msg.reply_markup.ID == "replyMarkupInlineKeyboard" and redis:get(ramoo..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(ramoo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(ramoo..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(ramoo.."lock_RandomRdod"..msg.chat_id_) then
local Replay = 0
Replay = redis:smembers(ramoo..':ReplayRandom:'..msg.text)
if #Replay ~= 0 then
...
Caption = redis:hget(ramoo..':caption_replay:Random:'..msg.text,CaptionFilter)
...
local Replay = 0
Replay = redis:smembers(ramoo..':ReplayRandom:'..msg.chat_id_..":"..msg.text)
if #Replay ~= 0 then
local Replay = Replay[math.random(#Replay)]
Replay = convert_Klmat(msg,data,Replay,true)
local CaptionFilter = Replay:gsub(":Text:",""):gsub(":Document:",""):gsub(":Voice:",""):gsub(":Photo:",""):gsub(":Animation:",""):gsub(":Audio:",""):gsub(":Sticker:",""):gsub(":Video:","")
Caption = redis:hget(ramoo..':caption_replay:Random:'..msg.chat_id_..msg.text,CaptionFilter)
Caption = convert_Klmat(msg,data,Caption)
if Replay:match(":Text:") then
return sendMsg(msg.chat_id_,msg.id_,Flter_Markdown(Replay:gsub(":Text:","")))
elseif Replay:match(":Document:") then
...
if redis:get(ramoo..'replay'..msg.chat_id_) then
local Replay = false

Replay = redis:hget(ramoo..'replay:all',msg.text)
if Replay then
Replay = convert_Klmat(msg,data,Replay,true)
...
Replay = redis:hget(ramoo..'replay:'..msg.chat_id_,msg.text)
if Replay then
Replay = convert_Klmat(msg,data,Replay,true)
sendMsg(msg.chat_id_,msg.id_,Flter_Markdown(Replay))
return false
...
Replay = redis:hget(ramoo..'replay_photo:group:',msg.text)
if Replay then
Caption = redis:hget(ramoo..':caption_replay:',msg.text)
Caption = convert_Klmat(msg,data,Caption)
print(Caption)
...
Replay = redis:hget(ramoo..'replay_voice:group:',msg.text)
if Replay then
Caption = redis:hget(ramoo..':caption_replay:',msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(ramoo..'replay_animation:group:',msg.text)
if Replay then
Caption = redis:hget(ramoo..':caption_replay:',msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(ramoo..'replay_audio:group:',msg.text)
if Replay then
Caption = redis:hget(ramoo..':caption_replay:',msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(ramoo..'replay_files:group:'..msg.chat_id_,msg.text)
if Replay then
Caption = redis:hget(ramoo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendDocument(msg.chat_id_,msg.id_,Replay,Caption)
return false
end

Replay = redis:hget(ramoo..'replay_files:group:',msg.text)
if Replay then
Caption = redis:hget(ramoo..':caption_replay:',msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendDocument(msg.chat_id_,msg.id_,Replay,Caption)
...
Replay = redis:hget(ramoo..'replay_sticker:group:',msg.text)
if Replay then
sendSticker(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(ramoo..'replay_video:group:',msg.text)
if Replay then
Caption = redis:hget(ramoo..':caption_replay:',msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(ramoo..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then
Caption = redis:hget(ramoo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendPhoto(msg.chat_id_,msg.id_,Replay,Caption)
...
Replay = redis:hget(ramoo..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then
Caption = redis:hget(ramoo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendVoice(msg.chat_id_,msg.id_,Replay,Caption)
...
Replay = redis:hget(ramoo..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then
Caption = redis:hget(ramoo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendAnimation(msg.chat_id_,msg.id_,Replay,Caption)
...
Replay = redis:hget(ramoo..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then
Caption = redis:hget(ramoo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendAudio(msg.chat_id_,msg.id_,Replay,"",Caption)
...
Replay = redis:hget(ramoo..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then
sendSticker(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(ramoo..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then
Caption = redis:hget(ramoo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendVideo(msg.chat_id_,msg.id_,Replay,Caption)
...
if msg.text and redis:get(ramoo.."lock_rdodSource"..msg.chat_id_) then
...
if redis:get(ramoo..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(ramoo..'ExpireDate:'..msg.chat_id_)
SUDO_USER = redis:hgetall(ramoo..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then
