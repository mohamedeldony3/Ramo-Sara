...
print(CmdSitting)
if CmdSitting then
local ResRedis =  redis:del(ramoo..CmdSitting..msg.chat_id_)
...
if not CheckUserAdmin(msg) then return answerCallbackQuery(data.id_,"ليس لديك صلاحية التحكم الادمن , ارجو المعذرة ❤️",true) end
if ResRedis == 0 then redis:set(ramoo..CmdSitting..msg.chat_id_,true) end
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " التعديل » '..(redis:get(ramoo..'lock_edit'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_edit"},'
..'{"text": " الروابط » '..(redis:get(ramoo..'lock_link'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_link"}],'

..'[{"text": " التاك » '..(redis:get(ramoo..'lock_tag'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_tag"},'
..'{"text": " المعرفات » '..(redis:get(ramoo..'lock_username'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_username"}],'

..'[{"text": " التكرار » '..(redis:get(ramoo..'lock_flood'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_flood"},'
..'{"text": " الكلايش » '..(redis:get(ramoo..'lock_spam'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_spam"}],'

..'[{"text": " الويب » '..(redis:get(ramoo..'lock_webpage'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_webpage"},'
..'{"text": " الماركدوان » '..(redis:get(ramoo..'lock_markdown'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_markdown"}],'

..'[{"text": " البوتات بالطرد » '..(redis:get(ramoo..'lock_bots_by_kick'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_bots_by_kick"},'
..'{"text": " البوتات » '..(redis:get(ramoo..'lock_bots'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_bots"}],'

..'[{"text": " الاضافه » '..(redis:get(ramoo..'lock_Add'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_Add"},'
..'{"text": " الاشعارات » '..(redis:get(ramoo..'mute_tgservice'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#mute_tgservice"}],'

..'[{"text": " الفشار » '..(redis:get(ramoo..'lock_mmno3'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_mmno3"},'
..'{"text": " الفارسيه » '..(redis:get(ramoo..'lock_pharsi'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_pharsi"}],'

..'[{"text": " الانكليزيه » '..(redis:get(ramoo..'lock_lang'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_lang"},'
..'{"text": " التوجيه » '..(redis:get(ramoo..'mute_forward'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#mute_forward"}],'
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " المتحركه » '..(redis:get(ramoo..'mute_gif'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_gif"},'
..'{"text": " الدردشه » '..(redis:get(ramoo..'mute_text'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_text"}],'

..'[{"text": " الانلاين » '..(redis:get(ramoo..'mute_inline'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_inline"},'
..'{"text": " الالعاب » '..(redis:get(ramoo..'mute_game'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_game"}],'

..'[{"text": " الصور » '..(redis:get(ramoo..'mute_photo'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_photo"},'
..'{"text": " الفيديو » '..(redis:get(ramoo..'mute_video'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_video"}],'

..'[{"text": " الصوت » '..(redis:get(ramoo..'mute_audio'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_audio"},'
..'{"text": " البصمات » '..(redis:get(ramoo..'mute_voice'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_voice"}],'

..'[{"text": " الملصقات » '..(redis:get(ramoo..'mute_sticker'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_sticker"},'
..'{"text": " الجهات » '..(redis:get(ramoo..'mute_contact'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_contact"}],'

..'[{"text": " الموقع » '..(redis:get(ramoo..'mute_location'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_location"},'
..'{"text": " الملفات » '..(redis:get(ramoo..'mute_document'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_document"}],'
..'[{"text": "- رجوع » ","callback_data": "CmdBack1"},{"text": "- اخفاء الامر","callback_data": "LoginOut"}]'
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " الايدي » '..(redis:get(ramoo..'lock_id'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_id"},'
..'{"text": " التاك للكل » '..(redis:get(ramoo..'lock_takkl'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_takkl"}],'

..'[{"text": " الترحيب » '..(redis:get(ramoo..'welcome:get'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#welcome:get"},'
..'{"text": " الردود » '..(redis:get(ramoo..'replay'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#replay"}],'

..'[{"text": " الردود العشوائيه » '..(redis:get(ramoo..'lock_tag'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_tag"},'
..'{"text": " التحذير » '..(redis:get(ramoo..'lock_woring'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_woring"}],'

..'[{"text": " تاك » '..(redis:get(ramoo..'lock_RandomRdod'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_RandomRdod"},'
..'{"text": " الرابط » '..(redis:get(ramoo..'lock_linkk'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_linkk"}],'

..'[{"text": " المغادره » '..(redis:get(ramoo..'lock_leftgroup'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_leftgroup"},'
..'{"text": " الحظر » '..(redis:get(ramoo..'lock_KickBan'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_KickBan"}],'

..'[{"text": " الحمايه » '..(redis:get(ramoo..'antiedit'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#antiedit"},'
..'{"text": " الايدي بالصوره » '..(redis:get(ramoo..'idphoto'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#idphoto"}],'

..'[{"text": " التحقق » '..(redis:get(ramoo..'lock_check'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_check"},'
..'{"text": " التنظيف التلقائي » '..(redis:get(ramoo..'lock_cleaner'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_cleaner"}],'
...
Adminn = true
elseif redis:sismember(ramoo..':SUDO_BOT:',msg.sender_user_id_) then
Adminn = true
elseif redis:sismember(ramoo..':Malk_Group:'..msg.chat_id_,msg.sender_user_id_) then
Adminn = true
elseif redis:sismember(ramoo..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then
Adminn = true
elseif redis:sismember(ramoo..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then
Adminn = true
elseif redis:sismember(ramoo..'owners:'..msg.chat_id_,msg.sender_user_id_) then
Adminn = true
elseif redis:sismember(ramoo..'admins:'..msg.chat_id_,msg.sender_user_id_) then
Adminn = true
end
return Adminn
end
...
download_file('https://raw.githubusercontent.com/T_O_Y_S/ramoo/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/T_O_Y_S/ramoo/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/T_O_Y_S/ramoo/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/T_O_Y_S/ramoo/master/inc/functions.lua','./inc/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n🔝-* تم تحديث السورس الى اصدار *v'..redis:get(ramoo..":VERSION")..'*\n📟-* تم اعاده تشغيل السورس بنجاح') end
if edit then dofile("./inc/Run.lua") end
print("Update Source And Reload ~ ./inc/Run.lua")

end
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(ramoo..":NameBot:") or "ساره"
...
usernn = data.username_ or "T_O_Y_S"
else
Name = data.title_
usernn = data.type_.user_.username_ or "T_O_Y_S"
end
Name = Name:gsub('[[][]]','')
...
Fshar_Word , res = https.request('https://api.th3ramoo.com/Words_Fshars.txt')
...
var = redis:get(ramoo..":RtbaNew1:"..ChatID) or 'مطور اساسي 👨🏻‍✈️'
elseif redis:sismember(ramoo..':SUDO_BOT:',UserID) then
var = redis:get(ramoo..":RtbaNew2:"..ChatID) or 'مطور البوت 👨🏽‍💻'
elseif redis:sismember(ramoo..':MONSHA_Group:'..ChatID,UserID) then
var = redis:get(ramoo..":RtbaNew3:"..ChatID) or ' المنشىء اساسي👷🏽'
elseif redis:sismember(ramoo..':Malk_Group:'..ChatID,UserID) then
var = redis:get(ramoo..":RtbaNew8:"..ChatID) or ' المالك 👷🏽'
elseif redis:sismember(ramoo..':MONSHA_BOT:'..ChatID,UserID) then
var = redis:get(ramoo..":RtbaNew4:"..ChatID) or ' المنشىء 👷🏽'
elseif redis:sismember(ramoo..'owners:'..ChatID,UserID) then
var = redis:get(ramoo..":RtbaNew5:"..ChatID) or 'مدير البوت 👨🏼‍⚕️'
elseif redis:sismember(ramoo..'admins:'..ChatID,UserID) then
var = redis:get(ramoo..":RtbaNew6:"..ChatID) or 'ادمن في البوت 👨🏼‍🎓'
elseif redis:sismember(ramoo..'whitelist:'..ChatID,UserID) then
var = redis:get(ramoo..":RtbaNew7:"..ChatID) or 'عضو مميز ⭐️'
else
var = 'فقط عضو 🙍🏼‍♂️'
end
return var
...
Replay = Replay:gsub("{البوت}",redis:get(ramoo..':NameBot:'))
...
if msg.edited then
redis:incr(ramoo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(ramoo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then
redis:incr(ramoo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(ramoo..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(ramoo..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(ramoo..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(ramoo..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(ramoo..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(ramoo..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local monshaas = redis:smembers(ramoo..':MONSHA_Group:'..msg.chat_id_)
local monsha = redis:smembers(ramoo..':MONSHA_BOT:'..msg.chat_id_)
local Owners = redis:smembers(ramoo..'owners:'..msg.chat_id_)
local Admins = redis:smembers(ramoo..'admins:'..msg.chat_id_)
local mmez = redis:smembers(ramoo..'whitelist:'..msg.chat_id_)
...
message = message ..i.. '-l ['..info.username..'](t.me/T_O_Y_S) \n'
end
...
local list = redis:smembers(ramoo..':SUDO_BOT:')
message = '- قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(ramoo..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا  *"
else
for k,v in pairs(list) do
local info  = redis:hgetall(ramoo..'username:'..v)
local count = redis:scard(ramoo..'mtwr_count'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.."-l ["..info.username..'] » (`' ..v.. '`){'..count..'} \n'
else
message = message ..k.. '-l ['..info.username..'](t.me/T_O_Y_S) l » (`' ..v.. '`){'..count..'} \n'
end
end
end
...
message = message ..k.. '-l ['..info.username..'](t.me/T_O_Y_S) l » (`' ..v.. '`) \n'
end
end
end
...
local list = redis:smembers(ramoo..'owners:'..msg.chat_id_)
if #list == 0 then
...
local list = redis:smembers(ramoo..':Malk_Group:'..msg.chat_id_)
if #list == 0 then
...
local list = redis:smembers(ramoo..'admins:'..msg.chat_id_)
...
local list = redis:smembers(ramoo..'whitelist:'..msg.chat_id_)
...
if redis:sismember(ramoo..'is_silent_users:'..Group,User) then
return true
else
return false
end
...
local res = https.request("http://api.th3ramoo.com/CheckUser/?User="..User)
if res == "false" then return true else return false end
end


function MuteUser_list(msg)
local list = redis:smembers(ramoo..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(ramoo..'banned:'..Group,User) then
return true
else
return false
end
...
local list = redis:smembers(ramoo..'bannedpv')
if #list==0 then return "- قائمة المحظورين فارغة " end
message = '-قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
local info = redis:hgetall(ramoo..'username:'..v)
...
if redis:sismember(ramoo..'gban_users',User) then
return true
else
return false
end
...
local list = redis:smembers(ramoo..'gban_users')
...
local list = redis:smembers(ramoo..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(ramoo..':Filter_Word:'..msg.chat_id_,word) then
return  "- الكلمه *{"..word.."}* هي بالتاكيد من قائمه المنع."
else
redis:sadd(ramoo..':Filter_Word:'..msg.chat_id_,word)
...
if redis:sismember(ramoo..':Filter_Word:'..msg.chat_id_,word) then
redis:srem(ramoo..':Filter_Word:'..msg.chat_id_,word)
...
local NumberFlood = tonumber(redis:get(ramoo..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then
result = false
else
redis:setex(ramoo..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..ramoo..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(ramoo..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(ramoo..'group:name'..GroupS) or '')
...
local admins = redis:smembers(ramoo..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(ramoo..'username:'..value)
if info then
...
local creator = redis:smembers(ramoo..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(ramoo..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(ramoo..'group:ids')
message = '-قائمه المجموعات :\n\n'
for k,v in pairs(list) do
local info = redis:get(ramoo..'group:name'..v)
if info then
...
redis:del(
ramoo..'group:add'..id_group,
ramoo..'lock_link'..id_group,
ramoo..'lock_id'..id_group,
ramoo..'lock_spam'..id_group,
ramoo..'lock_webpage'..id_group,
ramoo..'lock_markdown'..id_group,
ramoo..'lock_flood'..id_group,
ramoo..'lock_bots'..id_group,
ramoo..'mute_forward'..id_group,
ramoo..'mute_contact'..id_group,
ramoo..'mute_location'..id_group,
ramoo..'mute_document'..id_group,
ramoo..'mute_keyboard'..id_group,
ramoo..'mute_game'..id_group,
ramoo..'mute_inline'..id_group,
ramoo..'lock_username'..id_group,
ramoo..'num_msg_max'..id_group,
ramoo..'mute_text'..id_group,
ramoo..'admins:'..id_group,
ramoo..':Filter_Word:'..id_group,
ramoo..'banned:'..id_group,
ramoo..'is_silent_users:'..id_group,
ramoo..'whitelist:'..id_group,
ramoo..':MONSHA_BOT:'..id_group,
ramoo..'owners:'..id_group,
ramoo..'replay'..id_group,
ramoo..':MONSHA_Group:'..id_group,
ramoo..':Malk_Group:'..id_group
)
redis:srem(ramoo..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(ramoo..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(ramoo..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(ramoo..'admins:'..arg.chat_id_,data.id_)
...
function modadd(msg)
if redis:get(ramoo..'lock_service') then
lock_servicez = true
else
lock_servicez = false
end
...
if redis:get(ramoo..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'- المجموعه بالتاكيد ✓️ تم تفعيلها \n- بواسطه ⋙「 '..NameUser..' 」 \n') end
...
local GroupUsers = tonumber(redis:get(ramoo..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(ramoo..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(ramoo..':Malk_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
ramoo..'group:add'..arg.chat_id_,true,
ramoo..'lock_link'..arg.chat_id_,true,
ramoo..'lock_id'..arg.chat_id_,true,
ramoo..'lock_spam'..arg.chat_id_,true,
ramoo..'lock_webpage'..arg.chat_id_,true,
ramoo..'lock_markdown'..arg.chat_id_,true,
ramoo..'lock_flood'..arg.chat_id_,true,
ramoo..'lock_bots'..arg.chat_id_,true,
ramoo..'mute_forward'..arg.chat_id_,true,
ramoo..'mute_contact'..arg.chat_id_,true,
ramoo..'mute_location'..arg.chat_id_,true,
ramoo..'mute_document'..arg.chat_id_,true,
ramoo..'mute_keyboard'..arg.chat_id_,true,
ramoo..'mute_game'..arg.chat_id_,true,
ramoo..'mute_inline'..arg.chat_id_,true,
ramoo..'lock_username'..arg.chat_id_,true,
ramoo..'num_msg_max'..arg.chat_id_,5,
ramoo..'lock_edit'..arg.chat_id_,true,
ramoo..'replay'..arg.chat_id_,true,
ramoo..'lock_rdodSource'..arg.chat_id_,true,
ramoo.."lock_KickBan"..msg.chat_id_,true,
ramoo.."lock_mmno3"..msg.chat_id_,true,
ramoo.."lock_KickBan"..msg.chat_id_,true,
ramoo.."lock_RandomRdod"..msg.chat_id_,true,
ramoo.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(ramoo..'group:ids',arg.chat_id_)
redis:sadd(ramoo..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(ramoo..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(ramoo..'linkGroup'..arg.chat_id_,Gp_Link)
...
redis:sadd(ramoo..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم تقييده بنجاح ✓")
end
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(ramoo..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم فك تقييده بنجاح ")
end
if cmd == "setwhitelist" then
if redis:sismember(ramoo..'whitelist:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مميز  في المجموعه ✓")
end
redis:hset(ramoo..'username:'..UserID, 'username', Resolv)
redis:sadd(ramoo..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مميز  في المجموعه ✓")
end
if cmd == "remwhitelist" then
if not redis:sismember(ramoo..'whitelist:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مميز  في المجموعه ✓")
end
redis:srem(ramoo..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله مميز  في المجموعه ✓")
end
if cmd == "setmnsha" then
if redis:sismember(ramoo..':MONSHA_BOT:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه منشئ  في المجموعه ✓")
end
redis:hset(ramoo..'username:'..UserID, 'username', Resolv)
redis:sadd(ramoo..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه منشئ  في المجموعه ✓")
end
if cmd == "remmnsha" then
if not redis:sismember(ramoo..':MONSHA_BOT:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله منشئ  في المجموعه ")
end
redis:srem(ramoo..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله منشى  في المجموعه ✓")
end

if cmd == "setowner" then
if redis:sismember(ramoo..'owners:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مدير  في المجموعه ✓")
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(ramoo..'username:'..UserID, 'username', Resolv)
redis:sadd(ramoo..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مدير  في المجموعه ✓")
end
if cmd == "remowner" then
if not redis:sismember(ramoo..'owners:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مدير  في المجموعه ✓")
end
redis:srem(ramoo..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله مدير  في المجموعه ✓")
end
if cmd == "promote" then
if redis:sismember(ramoo..'admins:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه ادمن  في المجموعه ✓")
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(ramoo..'username:'..UserID, 'username', Resolv)
redis:sadd(ramoo..'admins:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه ادمن  في المجموعه ✓")
end
if cmd == "demote" then
if not redis:sismember(ramoo..'admins:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله ادمن  في المجموعه ✓")
end
redis:srem(ramoo..'admins:'..ChatID,UserID)
...
if cmd == "Upmonsh" then
if redis:sismember(ramoo..':MONSHA_Group:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه منشئ اساسي  في المجموعه ✓")
end
redis:hset(ramoo..'username:'..UserID,'username',USERNAME)
redis:sadd(ramoo..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه منشئ اساسي  في المجموعه ✓")
end

if cmd == "Dwmonsh" then
if not redis:sismember(ramoo..':MONSHA_Group:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله منشئ اساسي  في المجموعه ✓")
end
redis:srem(ramoo..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله منشئ اساسي  في المجموعه ✓")
end


if cmd == "UpMalk" then
if redis:sismember(ramoo..':Malk_Group:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مالك  في المجموعه ✓")
end
redis:hset(ramoo..'username:'..UserID,'username',USERNAME)
redis:sadd(ramoo..':Malk_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مالك  في المجموعه ✓")
end

if cmd == "DwnMalk" then
if not redis:sismember(ramoo..':Malk_Group:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مالك  في المجموعه ✓")
end
redis:srem(ramoo..':Malk_Group:'..ChatID,UserID)
...
redis:hset(ramoo..'username:'..UserID, 'username', Resolv)
redis:sadd(ramoo..'banned:'..ChatID,UserID)
...
redis:hset(ramoo..'username:'..UserID, 'username', Resolv)
redis:srem(ramoo..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(ramoo..'username:'..UserID, 'username', Resolv)
redis:sadd(ramoo..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم كتمه  من المجموعه ✓")
end
...
redis:hset(ramoo..'username:'..UserID, 'username', Resolv)
redis:srem(ramoo..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم الغاء كتمه  من المجموعه ✓")
end

if cmd == "upMshrf" then
redis:hset(ramoo..'username:'..UserID,'username',Resolv)
redis:setex(ramoo..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(ramoo..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
if cmd == "tfa3l" then
local maseegs = redis:get(ramoo..'msgs:'..UserID..':'..ChatID) or 1
local edited = redis:get(ramoo..':edited:'..ChatID..':'..UserID) or 0
local content = redis:get(ramoo..':adduser:'..ChatID..':'..UserID) or 0
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end
...
.."\n- التعديل » "..(redis:get(ramoo..'lock_edit'..msg.chat_id_) or 'false')
.."\n- الروابط » "..(redis:get(ramoo..'lock_link'..msg.chat_id_) or 'false')
.."\n- التاك » "..(redis:get(ramoo..'lock_tag'..msg.chat_id_) or 'false')
.."\n- المعرفات » "..(redis:get(ramoo..'lock_username'..msg.chat_id_) or 'false')
.."\n\n- التكرار » "..(redis:get(ramoo..'lock_flood'..msg.chat_id_) or 'false')
.."\n- الكلايش » "..(redis:get(ramoo..'lock_spam'..msg.chat_id_) or 'false')
.."\n- الويب » "..(redis:get(ramoo..'lock_webpage'..msg.chat_id_) or 'false')
.."\n- الماركدوان » "..(redis:get(ramoo..'lock_markdown'..msg.chat_id_) or 'false')
.."\n- البوتات بالطرد » "..(redis:get(ramoo..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n- البوتات » "..(redis:get(ramoo..'lock_bots'..msg.chat_id_) or 'false')
.."\n- عدد التكرار » "..(redis:get(ramoo..'num_msg_max'..msg.chat_id_) or 'false')
.."\n- وقت التنظيف » "..(redis:get(ramoo..':Timer_Cleaner:'..msg.chat_id_) or '6').." ساعة ."
.."\n\n-` اعدادات الوسائط :`\n"
.."\n- المتحركه » "..(redis:get(ramoo..'mute_gif'..msg.chat_id_) or 'false')
.."\n- الدردشه » "..(redis:get(ramoo..'mute_text'..msg.chat_id_) or 'false')
.."\n- الانلاين » "..(redis:get(ramoo..'mute_inline'..msg.chat_id_) or 'false')
.."\n- الالعاب » "..(redis:get(ramoo..'mute_game'..msg.chat_id_) or 'false')
.."\n- الصور » "..(redis:get(ramoo..'mute_photo'..msg.chat_id_) or 'false')
.."\n- الفيديو » "..(redis:get(ramoo..'mute_video'..msg.chat_id_) or 'false')
.."\n- الصوت » "..(redis:get(ramoo..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n- البصمات » "..(redis:get(ramoo..'mute_voice'..msg.chat_id_) or 'false')
.."\n- الملصقات » "..(redis:get(ramoo..'mute_sticker'..msg.chat_id_) or 'false')
.."\n- الجهات » "..(redis:get(ramoo..'mute_contact'..msg.chat_id_) or 'false')
.."\n- التوجيه » "..(redis:get(ramoo..'mute_forward'..msg.chat_id_) or 'false')
.."\n- الموقع » "..(redis:get(ramoo..'mute_location'..msg.chat_id_) or 'false')
.."\n- الملفات » "..(redis:get(ramoo..'mute_document'..msg.chat_id_) or 'false')
.."\n- الاشعارات » "..(redis:get(ramoo..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n- الفشار » "..(redis:get(ramoo..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n- الفارسيه » "..(redis:get(ramoo..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n- الانكليزيه » "..(redis:get(ramoo..'lock_lang'..msg.chat_id_) or 'false')
.."\n- الاضافه » "..(redis:get(ramoo..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n-` اعدادات اخرى : `"
.."\n- الترحيب » "..(redis:get(ramoo..'welcome:get'..msg.chat_id_) or 'false')
.."\n-  الردود » "..(redis:get(ramoo..'replay'..msg.chat_id_) or 'false')
.."\n-  الردود العشوائيه » "..(redis:get(ramoo.."lock_RandomRdod"..msg.chat_id_) or 'false')
.."\n-  التحذير » "..(redis:get(ramoo..'lock_woring'..msg.chat_id_) or 'false')
.."\n- الايدي » "..(redis:get(ramoo..'lock_id'..msg.chat_id_) or 'false')
.."\n- الرابط » "..(redis:get(ramoo..'lock_linkk'..msg.chat_id_) or 'false')
.."\n- المغادره » "..(redis:get(ramoo..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n- الحظر » "..(redis:get(ramoo..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n- الحمايه » "..(redis:get(ramoo..'antiedit'..msg.chat_id_) or 'false')
.."\n- التاك للكل » "..(redis:get(ramoo..'lock_takkl'..msg.chat_id_) or 'false')
.."\n- الايدي بالصوره » "..(redis:get(ramoo..'idphoto'..msg.chat_id_) or 'false')
.."\n- التحقق » "..(redis:get(ramoo.."lock_check"..msg.chat_id_) or 'false')
.."\n- التنظيف التلقائي » "..(redis:get(ramoo.."lock_cleaner"..msg.chat_id_) or 'false')
.."\n- ردود السورس » "..(redis:get(ramoo.."lock_rdodSource"..msg.chat_id_) or 'false')
...
.."\n- عدد التكرار » "..(redis:get(ramoo..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n-` اعدادات التقـييد :`\n"
.."\n- التقييد بالتوجيه » "..(redis:get(ramoo..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n- التقييد بالصور » "..(redis:get(ramoo..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n- التقييد بالروابط » "..(redis:get(ramoo..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n- التقييد بالمتحركه » "..(redis:get(ramoo..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n- التقييد الفيديو » "..(redis:get(ramoo..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n- الملفات » "..(redis:get(ramoo..'mute_document'..msg.chat_id_) or 'false')
.."\n- الاشعارات » "..(redis:get(ramoo..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n- الكيبورد » "..(redis:get(ramoo..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
